...
public class ApostaApplication_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.codex.aposta.ApostaApplication"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ApostaApplication_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.codex.aposta.ApostaApplication",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ApostaApplication_ESTest_scaffolding.class.getClassLoader()); 
