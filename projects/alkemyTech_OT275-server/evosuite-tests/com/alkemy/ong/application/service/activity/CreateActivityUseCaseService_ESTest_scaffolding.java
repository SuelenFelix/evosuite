...
public class CreateActivityUseCaseService_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.alkemy.ong.application.service.activity.CreateActivityUseCaseService"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CreateActivityUseCaseService_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.alkemy.ong.application.service.activity.CreateActivityUseCaseService",
      ...
      "com.alkemy.ong.application.service.activity.usecase.ICreateActivityUseCase",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.alkemy.ong.infrastructure.database.repository.abstraction.IActivitySpringRepository", false, CreateActivityUseCaseService_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CreateActivityUseCaseService_ESTest_scaffolding.class.getClassLoader()); 
