...
public class HexagonalArchitectureApplication_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.martinachov.hexagonal.HexagonalArchitectureApplication"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(HexagonalArchitectureApplication_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.martinachov.hexagonal.HexagonalArchitectureApplication",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(HexagonalArchitectureApplication_ESTest_scaffolding.class.getClassLoader()); 
