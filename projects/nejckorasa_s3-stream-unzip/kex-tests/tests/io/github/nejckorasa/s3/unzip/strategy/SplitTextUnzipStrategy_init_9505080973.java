...
public class SplitTextUnzipStrategy_init_9505080973 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public SplitTextUnzipStrategy_init_9505080973() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        argTypes[0] = Class.forName("io.github.nejckorasa.s3.upload.S3MultipartUpload$Config");
