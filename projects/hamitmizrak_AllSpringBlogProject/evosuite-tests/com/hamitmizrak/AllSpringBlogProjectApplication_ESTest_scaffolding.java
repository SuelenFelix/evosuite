...
public class AllSpringBlogProjectApplication_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.hamitmizrak.AllSpringBlogProjectApplication"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AllSpringBlogProjectApplication_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.hamitmizrak.AllSpringBlogProjectApplication",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AllSpringBlogProjectApplication_ESTest_scaffolding.class.getClassLoader()); 
