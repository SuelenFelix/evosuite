...
public class BerryFirmness_setNames_159211504017 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term401;

    public BerryFirmness_setNames_159211504017() {
    }
    ...
    public void setup() throws Throwable {
        term401 = newInstance(Class.forName("skaro.pokeapi.resource.berryfirmness.BerryFirmness"));
        setField(term401, term401.getClass(), "id", null);
        setField(term401, term401.getClass(), "name", null);
        setField(term401, term401.getClass(), "berries", null);
