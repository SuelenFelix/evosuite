...
public class RelationshipApplication_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.datajpa.relationship.RelationshipApplication"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(RelationshipApplication_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.datajpa.relationship.RelationshipApplication",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(RelationshipApplication_ESTest_scaffolding.class.getClassLoader()); 
