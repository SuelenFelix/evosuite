...
public class DataSourceConfig_getId_8329083011 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term1;

    public DataSourceConfig_getId_8329083011() {
    }
    ...
    public void setup() throws Throwable {
        ...
        term1 = newInstance(Class.forName("com.codingworld.multitenant.config.DataSourceConfig"));
        setField(term1, term1.getClass(), "id", term2);
        setField(term1, term1.getClass(), "name", "PAEBtnZtTD");
        setField(term1, term1.getClass(), "url", "sjlJAEtRrb");
        setField(term1, term1.getClass(), "username", "MuLcgQHgqz");
        setField(term1, term1.getClass(), "password", "xxtlPwDYFs");
        setField(term1, term1.getClass(), "driverClassName", "jJCZpVmanW");
        setBooleanField(term1, term1.getClass(), "initialize", false);
    }
