...
public class GetGameSettingResp_isAouAccession_487378550 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term1;

    public GetGameSettingResp_isAouAccession_487378550() {
    }
    ...
    public void setup() throws Throwable {
        term1 = newInstance(Class.forName("icu.samnyan.aqua.sega.maimai2.model.response.GetGameSettingResp"));
        Object term3 = newInstance(Class.forName("icu.samnyan.aqua.sega.maimai2.model.response.data.GameSetting"));
        ...
        setIntField(term3, term3.getClass(), "rebootInterval", 391863371);
