...
public class NoSplitUnzipStrategy_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "io.github.nejckorasa.s3.unzip.strategy.NoSplitUnzipStrategy"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(NoSplitUnzipStrategy_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.amazonaws.services.s3.AmazonS3", false, NoSplitUnzipStrategy_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.amazonaws.services.s3.model.InitiateMultipartUploadResult", false, NoSplitUnzipStrategy_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(NoSplitUnzipStrategy_ESTest_scaffolding.class.getClassLoader()); 
