...
public class EqualityUtils {
  ...
  public static boolean equalsObjectArray(
      Object[] t1,
      Object[] t2,
      Map<Object, Object> visitedFirstToSecond,
      Map<Object, Object> visitedSecondToFirst) {
  ...
  public static boolean equalsObject(
    ...
    for (Map.Entry<String, Object> entry : t1Fields.entrySet()) {
      ...
      if (!equalsAll(
          entry.getValue(),
          t2Fields.get(entry.getKey()),
          visitedFirstToSecond,
          visitedSecondToFirst)) return false;
    }
  ...
  public static boolean equalsAll(
    ...
    if (clazz.isArray()) {
      return equalsObjectArray(
          (Object[]) t1, (Object[]) t2, visitedFirstToSecond, visitedSecondToFirst);
    }
