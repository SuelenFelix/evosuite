...
public class FileBO_FileBOBuilder_meta_109434299317 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term3600;

    public FileBO_FileBOBuilder_meta_109434299317() {
    }
    ...
    public void setup() throws Throwable {
        term3600 = newInstance(Class.forName("net.jaggerwang.sbip.entity.FileBO$FileBOBuilder"));
