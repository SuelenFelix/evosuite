...
public class ProducerImpl_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.industrieit.ledger.clientledger.core.db.consumer.impl.ProducerImpl"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ProducerImpl_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.fasterxml.jackson.databind.Module", false, ProducerImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.databind.deser.DefaultDeserializationContext", false, ProducerImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.databind.ser.DefaultSerializerProvider", false, ProducerImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.industrieit.ledger.clientledger.core.db.repository.TransactionResultRepository", false, ProducerImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.kafka.clients.producer.Producer", false, ProducerImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.springframework.kafka.core.ProducerFactory", false, ProducerImpl_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ProducerImpl_ESTest_scaffolding.class.getClassLoader()); 
