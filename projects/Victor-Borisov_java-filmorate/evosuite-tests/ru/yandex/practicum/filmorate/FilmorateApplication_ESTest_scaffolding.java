...
public class FilmorateApplication_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "ru.yandex.practicum.filmorate.FilmorateApplication"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(FilmorateApplication_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "ru.yandex.practicum.filmorate.FilmorateApplication",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(FilmorateApplication_ESTest_scaffolding.class.getClassLoader()); 
