...
public class StringWeigher_weigh_20681701651 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public StringWeigher_weigh_20681701651() {
    }
    ...
    public void test() throws Throwable, Throwable {
        Class<?> klass = Class.forName("com.rtbhouse.kafka.workers.api.record.weigher.StringWeigher");
