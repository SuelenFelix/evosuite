...
public class SqliteDanMuReader_reloadTempMap_17259938590 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public SqliteDanMuReader_reloadTempMap_17259938590() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "reloadTempMap", argTypes, null, args);
    }
