...
public class DataTypeFeature_valueOf_6776341164 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object enum1;

    public DataTypeFeature_valueOf_6776341164() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term691 = Class.forName((String) "org.openapijsonschematools.codegen.generators.generatormetadata.features.DataTypeFeature");
        Field term690 = ((Class) term691).getDeclaredField((String) "Date");
        ((Field) term690).setAccessible(true);
        enum1 = ((Field) term690).get((Object) null);
    }
