...
public class FOREXIDTimeSeriesPointInfluxdb_getTime_2835771981 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term1;

    public FOREXIDTimeSeriesPointInfluxdb_getTime_2835771981() {
    }
    ...
    public void setup() throws Throwable {
        ...
        term1 = newInstance(Class.forName("data.source.external.database.influxdb.mirrors.FOREXIDTimeSeriesPointInfluxdb"));
