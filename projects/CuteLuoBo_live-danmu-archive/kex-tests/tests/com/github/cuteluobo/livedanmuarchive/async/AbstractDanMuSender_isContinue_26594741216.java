...
public class AbstractDanMuSender_isContinue_26594741216 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public AbstractDanMuSender_isContinue_26594741216() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "isContinue", argTypes, null, args);
    }
