...
public class UserSecurityService_validatePasswordResetToken_14374510171 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public UserSecurityService_validatePasswordResetToken_14374510171() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "PAEBtnZtTD";
        callMethod(klass, "validatePasswordResetToken", argTypes, null, args);
    }
