...
public class GeoPackageCoreCache_closeIfCached_25445873033 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public GeoPackageCoreCache_closeIfCached_25445873033() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        callMethod(klass, "closeIfCached", argTypes, null, args);
    }
