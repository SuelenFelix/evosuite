...
public class Role_valueOf_14767060125 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object enum2;

    public Role_valueOf_14767060125() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term738 = Class.forName((String) "com.alkemy.ong.infrastructure.config.spring.security.common.Role");
        Field term737 = ((Class) term738).getDeclaredField((String) "ADMIN");
        ((Field) term737).setAccessible(true);
        enum2 = ((Field) term737).get((Object) null);
    }
