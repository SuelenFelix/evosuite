...
public class RetryFailedPaymentsServiceImpl_safeDouble_2228000162 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public RetryFailedPaymentsServiceImpl_safeDouble_2228000162() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "YAXkVjQZcV";
        callMethod(klass, "safeDouble", argTypes, null, args);
    }
