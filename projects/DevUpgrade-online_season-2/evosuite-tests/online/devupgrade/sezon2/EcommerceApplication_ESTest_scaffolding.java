...
public class EcommerceApplication_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "online.devupgrade.sezon2.EcommerceApplication"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(EcommerceApplication_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "online.devupgrade.sezon2.EcommerceApplication",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(EcommerceApplication_ESTest_scaffolding.class.getClassLoader()); 
