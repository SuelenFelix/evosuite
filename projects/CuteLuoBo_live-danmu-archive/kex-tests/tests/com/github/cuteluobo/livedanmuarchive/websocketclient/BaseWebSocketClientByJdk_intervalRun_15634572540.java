...
public class BaseWebSocketClientByJdk_intervalRun_15634572540 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BaseWebSocketClientByJdk_intervalRun_15634572540() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "intervalRun", argTypes, null, args);
    }
