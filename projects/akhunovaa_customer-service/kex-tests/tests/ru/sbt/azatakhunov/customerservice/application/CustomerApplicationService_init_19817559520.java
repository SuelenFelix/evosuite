...
public class CustomerApplicationService_init_19817559520 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term1;
     Object term2;

    public CustomerApplicationService_init_19817559520() {
    }
    ...
    public void setup() throws Throwable {
        term1 = newInstance(Class.forName("ru.sbt.azatakhunov.customerservice.domain.CustomerFactoryService"));
        term2 = newInstance(Class.forName("ru.sbt.azatakhunov.customerservice.port.adapter.persistance.CustomerRepository"));
    }
