...
public class ProductResponse_ProductResponseBuilder_toString_201430150411 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term286;

    public ProductResponse_ProductResponseBuilder_toString_201430150411() {
    }
    ...
    public void setup() throws Throwable {
        term286 = newInstance(Class.forName("com.martinachov.hexagonal.infrastructure.adapters.input.rest.data.response.ProductResponse$ProductResponseBuilder"));
