...
public class CustomerInfoDTO_toBuilder_2624991671 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term1;

    public CustomerInfoDTO_toBuilder_2624991671() {
    }
    ...
    public void setup() throws Throwable {
        term1 = newInstance(Class.forName("ru.sbt.azatakhunov.customerservice.web.controller.dto.CustomerInfoDTO"));
