...
public class UpsertClientSettingHandler_init_1867919981 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public UpsertClientSettingHandler_init_1867919981() {
    }
    ...
    public void test() throws Throwable, Throwable {
        Class<?> klass = Class.forName("icu.samnyan.aqua.sega.chunithm.handler.impl.UpsertClientSettingHandler");
