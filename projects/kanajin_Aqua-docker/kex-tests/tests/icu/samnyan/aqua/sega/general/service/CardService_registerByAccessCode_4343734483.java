...
public class CardService_registerByAccessCode_4343734483 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public CardService_registerByAccessCode_4343734483() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "SzjVpOQTyS";
        callMethod(klass, "registerByAccessCode", argTypes, null, args);
    }
