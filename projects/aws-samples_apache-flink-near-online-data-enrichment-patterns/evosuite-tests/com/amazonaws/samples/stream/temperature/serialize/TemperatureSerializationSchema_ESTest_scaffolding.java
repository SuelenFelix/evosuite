...
public class TemperatureSerializationSchema_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.amazonaws.samples.stream.temperature.serialize.TemperatureSerializationSchema"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(TemperatureSerializationSchema_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.apache.flink.api.common.serialization.SerializationSchema$InitializationContext", false, TemperatureSerializationSchema_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(TemperatureSerializationSchema_ESTest_scaffolding.class.getClassLoader()); 
