...
public class Employee_createEmployeeType_15870877505 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term115;

    public Employee_createEmployeeType_15870877505() {
    }
    ...
    public void setup() throws Throwable {
        term115 = newInstance(Class.forName("refactoring.app.chapter12.replaceTypeCodeWithSubclasses.indirect.Employee"));
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        callMethod(klass, "createEmployeeType", argTypes, term115, args);
    }
