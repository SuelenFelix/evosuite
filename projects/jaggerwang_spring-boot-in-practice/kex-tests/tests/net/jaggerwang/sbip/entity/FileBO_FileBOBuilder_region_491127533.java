...
public class FileBO_FileBOBuilder_region_491127533 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term708;
     Object enum2;

    public FileBO_FileBOBuilder_region_491127533() {
    }
    ...
    public void setup() throws Throwable {
        ...
        term708 = newInstance(Class.forName("net.jaggerwang.sbip.entity.FileBO$FileBOBuilder"));
