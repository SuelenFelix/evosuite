...
public class ApiAuthenticationApplication_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.example.api.ApiAuthenticationApplication"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ApiAuthenticationApplication_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.example.api.ApiAuthenticationApplication",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ApiAuthenticationApplication_ESTest_scaffolding.class.getClassLoader()); 
