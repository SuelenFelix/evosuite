...
public class JsonDanMuExportServiceImpl_saveToFile_12043351535 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public JsonDanMuExportServiceImpl_saveToFile_12043351535() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "saveToFile", argTypes, null, args);
    }
