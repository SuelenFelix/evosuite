...
public class KarmaType_valueOf_17434276126 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object enum2;

    public KarmaType_valueOf_17434276126() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term875 = Class.forName((String) "org.openRealmOfStars.starMap.event.karmaEvents.KarmaType");
        Field term874 = ((Class) term875).getDeclaredField((String) "RANDOM");
        ((Field) term874).setAccessible(true);
        enum2 = ((Field) term874).get((Object) null);
    }
