...
public class VibeChartService_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.maxjang.chart.vibe.VibeChartService"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(VibeChartService_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.maxjang.chart.vibe.VibeChartService",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(VibeChartService_ESTest_scaffolding.class.getClassLoader()); 
