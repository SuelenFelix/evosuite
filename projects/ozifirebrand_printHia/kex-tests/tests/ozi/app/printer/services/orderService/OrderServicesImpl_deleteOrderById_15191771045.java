...
public class OrderServicesImpl_deleteOrderById_15191771045 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public OrderServicesImpl_deleteOrderById_15191771045() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "NRdvgJlhkX";
        callMethod(klass, "deleteOrderById", argTypes, null, args);
    }
