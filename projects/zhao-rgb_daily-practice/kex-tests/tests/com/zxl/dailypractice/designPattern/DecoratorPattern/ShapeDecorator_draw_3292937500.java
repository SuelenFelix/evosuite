...
public class ShapeDecorator_draw_3292937500 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public ShapeDecorator_draw_3292937500() {
    }
    ...
    public void test() throws Throwable, Throwable {
        Class<?> klass = Class.forName("com.zxl.dailypractice.designPattern.DecoratorPattern.ShapeDecorator");
