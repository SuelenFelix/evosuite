...
public class VectorTilesExtension_init_8867243811 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public VectorTilesExtension_init_8867243811() {
    }
    ...
    public void test() throws Throwable, Throwable {
        Class<?> klass = Class.forName("mil.nga.geopackage.extension.im.vector_tiles.VectorTilesExtension");
