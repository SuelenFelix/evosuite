...
public class EmbeddingConfiguration_getEmbeddingModel_19523515614 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public EmbeddingConfiguration_getEmbeddingModel_19523515614() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "XylxrMBraH";
        callMethod(klass, "getEmbeddingModel", argTypes, null, args);
    }
