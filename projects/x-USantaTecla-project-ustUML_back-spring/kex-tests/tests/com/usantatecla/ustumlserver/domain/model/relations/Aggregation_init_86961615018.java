...
public class Aggregation_init_86961615018 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public Aggregation_init_86961615018() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        argTypes[0] = Class.forName("com.usantatecla.ustumlserver.domain.model.relations.Aggregation$AggregationBuilder");
