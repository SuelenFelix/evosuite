...
public class TileMatrixDao_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "mil.nga.geopackage.tiles.matrix.TileMatrixDao"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(TileMatrixDao_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.j256.ormlite.stmt.query.ManyClause$Operation",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.j256.ormlite.db.DatabaseType", false, TileMatrixDao_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.j256.ormlite.support.ConnectionSource", false, TileMatrixDao_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("mil.nga.geopackage.GeoPackageCore", false, TileMatrixDao_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("mil.nga.geopackage.db.GeoPackageCoreConnection", false, TileMatrixDao_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(TileMatrixDao_ESTest_scaffolding.class.getClassLoader()); 
