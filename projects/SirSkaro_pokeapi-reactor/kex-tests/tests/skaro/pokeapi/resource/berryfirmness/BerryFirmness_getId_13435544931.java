...
public class BerryFirmness_getId_13435544931 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term1;

    public BerryFirmness_getId_13435544931() {
    }
    ...
    public void setup() throws Throwable {
        ...
        term1 = newInstance(Class.forName("skaro.pokeapi.resource.berryfirmness.BerryFirmness"));
        setField(term1, term1.getClass(), "id", term2);
        setField(term1, term1.getClass(), "name", "PAEBtnZtTD");
        setField(term1, term1.getClass(), "berries", term16);
