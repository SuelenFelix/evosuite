...
public class ProjectCreateDto_toString_121936149913 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term198;

    public ProjectCreateDto_toString_121936149913() {
    }
    ...
    public void setup() throws Throwable {
        term198 = newInstance(Class.forName("ru.smartup.timetracker.dto.project.request.ProjectCreateDto"));
