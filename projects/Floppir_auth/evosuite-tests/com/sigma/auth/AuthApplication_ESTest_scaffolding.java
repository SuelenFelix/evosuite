...
public class AuthApplication_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.sigma.auth.AuthApplication"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AuthApplication_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.sigma.auth.AuthApplication",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AuthApplication_ESTest_scaffolding.class.getClassLoader()); 
