...
public class EmailSenderApplication_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.example.emailsender.EmailSenderApplication"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(EmailSenderApplication_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.example.emailsender.EmailSenderApplication",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(EmailSenderApplication_ESTest_scaffolding.class.getClassLoader()); 
