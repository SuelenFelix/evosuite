...
public class DefaultStep_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.Function", false, DefaultStep_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Supplier", false, DefaultStep_ESTest_scaffolding.class.getClassLoader()));
  }
