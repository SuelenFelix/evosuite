...
public class DsnUpdate_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "zowe.client.sdk.zosfiles.dsn.methods.DsnUpdate"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DsnUpdate_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "zowe.client.sdk.zosfiles.dsn.input.DsnRenameInputData",
      ...
      "zowe.client.sdk.zosfiles.dsn.methods.DsnUpdate",
      ...
      "zowe.client.sdk.zosfiles.dsn.types.RenameType",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("zowe.client.sdk.core.ZosConnection", false, DsnUpdate_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DsnUpdate_ESTest_scaffolding.class.getClassLoader()); 
