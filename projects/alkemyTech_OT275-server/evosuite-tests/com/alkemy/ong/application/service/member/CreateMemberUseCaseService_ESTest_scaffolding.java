...
public class CreateMemberUseCaseService_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.alkemy.ong.application.service.member.CreateMemberUseCaseService"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CreateMemberUseCaseService_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.alkemy.ong.application.service.member.usecase.ICreateMemberUseCase",
      ...
      "com.alkemy.ong.application.service.member.CreateMemberUseCaseService",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.alkemy.ong.infrastructure.database.repository.abstraction.IMemberSpringRepository", false, CreateMemberUseCaseService_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CreateMemberUseCaseService_ESTest_scaffolding.class.getClassLoader()); 
