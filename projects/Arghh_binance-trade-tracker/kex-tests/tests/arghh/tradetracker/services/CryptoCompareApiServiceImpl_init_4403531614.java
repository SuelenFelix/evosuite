...
public class CryptoCompareApiServiceImpl_init_4403531614 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public CryptoCompareApiServiceImpl_init_4403531614() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        argTypes[0] = Class.forName("arghh.tradetracker.services.TradeService");
