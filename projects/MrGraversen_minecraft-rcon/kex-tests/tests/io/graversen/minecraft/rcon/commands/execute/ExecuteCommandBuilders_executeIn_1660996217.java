...
public class ExecuteCommandBuilders_executeIn_1660996217 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term1540;

    public ExecuteCommandBuilders_executeIn_1660996217() {
    }
    ...
    public void setup() throws Throwable {
        term1540 = newInstance(Class.forName("io.graversen.minecraft.rcon.commands.execute.ExecuteCommandBuilders"));
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        callMethod(klass, "executeIn", argTypes, term1540, args);
    }
