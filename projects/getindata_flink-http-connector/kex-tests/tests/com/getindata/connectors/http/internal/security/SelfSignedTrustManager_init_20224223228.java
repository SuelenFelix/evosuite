...
public class SelfSignedTrustManager_init_20224223228 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public SelfSignedTrustManager_init_20224223228() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        argTypes[0] = Class.forName("javax.net.ssl.X509TrustManager");
