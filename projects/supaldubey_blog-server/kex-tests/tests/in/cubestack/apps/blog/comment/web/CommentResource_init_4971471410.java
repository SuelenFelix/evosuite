...
public class CommentResource_init_4971471410 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public CommentResource_init_4971471410() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        argTypes[0] = Class.forName("in.cubestack.apps.blog.comment.service.CommentService");
