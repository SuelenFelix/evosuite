...
public class Function_getValue_1572291734 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object enum1;

    public Function_getValue_1572291734() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term2175 = Class.forName((String) "data.source.external.financialdatavendors.alphavantage.parameters.functions.Function");
        Field term2174 = ((Class) term2175).getDeclaredField((String) "BBANDS");
        ((Field) term2174).setAccessible(true);
        enum1 = ((Field) term2174).get((Object) null);
    }
