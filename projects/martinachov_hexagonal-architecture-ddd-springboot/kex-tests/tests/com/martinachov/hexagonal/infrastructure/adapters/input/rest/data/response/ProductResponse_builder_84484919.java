...
public class ProductResponse_builder_84484919 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term661;

    public ProductResponse_builder_84484919() {
    }
    ...
    public void setup() throws Throwable {
        term661 = newInstance(Class.forName("com.martinachov.hexagonal.infrastructure.adapters.input.rest.data.response.ProductResponse"));
