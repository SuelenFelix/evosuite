...
public class FinallyBlockVisitor_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "ix.ibm.sonar.java.visitors.FinallyBlockVisitor"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(FinallyBlockVisitor_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "ix.ibm.sonar.java.visitors.FinallyBlockVisitor",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.sonar.plugins.java.api.tree.BlockTree", false, FinallyBlockVisitor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sonar.plugins.java.api.tree.TryStatementTree", false, FinallyBlockVisitor_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(FinallyBlockVisitor_ESTest_scaffolding.class.getClassLoader()); 
