...
public class InjectAnnotationFinder_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "ix.ibm.sonar.java.visitors.InjectAnnotationFinder"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(InjectAnnotationFinder_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "ix.ibm.sonar.java.visitors.InjectAnnotationFinder",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.sonar.plugins.java.api.semantic.Type", false, InjectAnnotationFinder_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sonar.plugins.java.api.tree.AnnotationTree", false, InjectAnnotationFinder_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sonar.plugins.java.api.tree.TypeTree", false, InjectAnnotationFinder_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(InjectAnnotationFinder_ESTest_scaffolding.class.getClassLoader()); 
