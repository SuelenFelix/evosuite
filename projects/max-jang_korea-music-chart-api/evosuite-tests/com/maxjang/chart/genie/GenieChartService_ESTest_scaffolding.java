...
public class GenieChartService_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.maxjang.chart.genie.GenieChartService"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(GenieChartService_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.maxjang.chart.genie.GenieChartService",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(GenieChartService_ESTest_scaffolding.class.getClassLoader()); 
