...
public class ServiceDiscovery_parseBridgeId_11473574011 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public ServiceDiscovery_parseBridgeId_11473574011() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "MxlszYVzRf";
        callMethod(klass, "parseBridgeId", argTypes, null, args);
    }
