...
public class CodegenSchema_isSimpleInteger_1332961094 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public CodegenSchema_isSimpleInteger_1332961094() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "isSimpleInteger", argTypes, null, args);
    }
