...
public class SpringConfiguration_init_11702922430 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public SpringConfiguration_init_11702922430() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        argTypes[0] = Class.forName("com.bslota.optimisticapi.holding.domain.BookRepository");
