...
public class CameraProxyRoutes_getProxyPath_19224687410 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public CameraProxyRoutes_getProxyPath_19224687410() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "getProxyPath", argTypes, null, args);
    }
