...
public class Presenter_init_10913401832 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public Presenter_init_10913401832() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        argTypes[0] = Class.forName("codeplays.trainee.cleanarch.infra.adapter.presenter.ViewAdapter");
