...
public class MultiFoo_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "programmerzamannow.spring.core.data.MultiFoo"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(MultiFoo_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "programmerzamannow.spring.core.data.MultiFoo",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.stream.Stream", false, MultiFoo_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.springframework.beans.factory.ObjectProvider", false, MultiFoo_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(MultiFoo_ESTest_scaffolding.class.getClassLoader()); 
