...
public class URLEncodedUtils_splitPathSegments_17189460464 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public URLEncodedUtils_splitPathSegments_17189460464() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        callMethod(klass, "splitPathSegments", argTypes, null, args);
    }
