...
public class AttributeType_values_790011833 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object enum0;

    public AttributeType_values_790011833() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term51 = Class.forName((String) "zowe.client.sdk.zosfiles.dsn.types.AttributeType");
        Field term50 = ((Class) term51).getDeclaredField((String) "BASE");
