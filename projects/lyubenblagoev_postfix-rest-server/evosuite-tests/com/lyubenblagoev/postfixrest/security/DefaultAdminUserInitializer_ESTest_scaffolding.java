...
public class DefaultAdminUserInitializer_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.lyubenblagoev.postfixrest.entity.Role", false, DefaultAdminUserInitializer_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.lyubenblagoev.postfixrest.entity.User", false, DefaultAdminUserInitializer_ESTest_scaffolding.class.getClassLoader()));
