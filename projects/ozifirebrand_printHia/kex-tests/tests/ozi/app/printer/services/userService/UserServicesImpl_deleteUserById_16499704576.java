...
public class UserServicesImpl_deleteUserById_16499704576 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public UserServicesImpl_deleteUserById_16499704576() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "NRdvgJlhkX";
        callMethod(klass, "deleteUserById", argTypes, null, args);
    }
