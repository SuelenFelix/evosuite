...
public class PessoaController_findPersonByName_9805045944 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public PessoaController_findPersonByName_9805045944() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "jJCZpVmanW";
        callMethod(klass, "findPersonByName", argTypes, null, args);
    }
