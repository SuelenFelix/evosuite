...
public class ExtensionManager_getAuthor_15246630851 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term1;

    public ExtensionManager_getAuthor_15246630851() {
    }
    ...
    public void setup() throws Throwable {
        ...
        ((ArrayList) term2).add((Object)null);
        ((ArrayList) term2).add((Object)null);
        term1 = newInstance(Class.forName("mil.nga.geopackage.extension.ExtensionManager"));
        setField(term1, term1.getClass(), "communityExtensions", term2);
