...
public class GetUserRivalDataHandler_init_11591140901 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public GetUserRivalDataHandler_init_11591140901() {
    }
    ...
    public void test() throws Throwable, Throwable {
        Class<?> klass = Class.forName("icu.samnyan.aqua.sega.chunithm.handler.impl.GetUserRivalDataHandler");
