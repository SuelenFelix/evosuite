...
public class Employee_createEmployeeType_15870877501 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public Employee_createEmployeeType_15870877501() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "MuLcgQHgqz";
        callMethod(klass, "createEmployeeType", argTypes, null, args);
    }
