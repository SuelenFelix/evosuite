...
public class ListUserUseCaseService_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.alkemy.ong.application.service.user.ListUserUseCaseService"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ListUserUseCaseService_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.alkemy.ong.application.service.user.usecase.IListUserUseCase",
      ...
      "com.alkemy.ong.application.service.user.ListUserUseCaseService",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.alkemy.ong.infrastructure.database.repository.abstraction.IUserSpringRepository", false, ListUserUseCaseService_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ListUserUseCaseService_ESTest_scaffolding.class.getClassLoader()); 
