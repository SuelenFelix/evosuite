...
public class UserService_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "codeit.gatcha.domain.user.service.signUp.UserService"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("codeit.gatcha.domain.user.repo.IUserRepo", false, UserService_ESTest_scaffolding.class.getClassLoader()));
  }
