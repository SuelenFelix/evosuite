...
public class OrderServicesImpl_getOrdersByUserId_195779540914 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public OrderServicesImpl_getOrdersByUserId_195779540914() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "ZiaGIbnzTs";
        callMethod(klass, "getOrdersByUserId", argTypes, null, args);
    }
