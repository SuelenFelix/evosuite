...
public class Entity_getData_9232922443 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term46;

    public Entity_getData_9232922443() {
    }
    ...
    public void setup() throws Throwable {
        term46 = newInstance(Class.forName("codeplays.trainee.cleanarch.domain.entity.Entity"));
