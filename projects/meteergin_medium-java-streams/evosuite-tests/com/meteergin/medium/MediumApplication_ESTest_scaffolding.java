...
public class MediumApplication_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.meteergin.medium.MediumApplication"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(MediumApplication_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.meteergin.medium.MediumApplication",
      "org.springframework.util.StringUtils"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(MediumApplication_ESTest_scaffolding.class.getClassLoader()); 
