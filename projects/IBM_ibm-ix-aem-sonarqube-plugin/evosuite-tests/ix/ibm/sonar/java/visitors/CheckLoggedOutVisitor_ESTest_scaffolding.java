...
public class CheckLoggedOutVisitor_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "ix.ibm.sonar.java.visitors.CheckLoggedOutVisitor"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CheckLoggedOutVisitor_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "ix.ibm.sonar.java.visitors.CheckLoggedOutVisitor",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.sonar.plugins.java.api.tree.IdentifierTree", false, CheckLoggedOutVisitor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sonar.plugins.java.api.tree.MemberSelectExpressionTree", false, CheckLoggedOutVisitor_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CheckLoggedOutVisitor_ESTest_scaffolding.class.getClassLoader()); 
