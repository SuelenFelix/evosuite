...
public class MarkovClusteringExternalCommand_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.nlpub.watset.cli.MarkovClusteringExternalCommand"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(MarkovClusteringExternalCommand_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(MarkovClusteringExternalCommand_ESTest_scaffolding.class.getClassLoader()); 
