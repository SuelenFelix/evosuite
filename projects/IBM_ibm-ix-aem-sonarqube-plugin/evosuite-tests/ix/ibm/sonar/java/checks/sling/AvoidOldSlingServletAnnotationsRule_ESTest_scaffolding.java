...
public class AvoidOldSlingServletAnnotationsRule_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "ix.ibm.sonar.java.checks.sling.AvoidOldSlingServletAnnotationsRule"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AvoidOldSlingServletAnnotationsRule_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "ix.ibm.sonar.java.utils.AemRecognizer",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.sonar.plugins.java.api.semantic.Symbol$TypeSymbol", false, AvoidOldSlingServletAnnotationsRule_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sonar.plugins.java.api.semantic.Type", false, AvoidOldSlingServletAnnotationsRule_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sonar.plugins.java.api.tree.ClassTree", false, AvoidOldSlingServletAnnotationsRule_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AvoidOldSlingServletAnnotationsRule_ESTest_scaffolding.class.getClassLoader()); 
