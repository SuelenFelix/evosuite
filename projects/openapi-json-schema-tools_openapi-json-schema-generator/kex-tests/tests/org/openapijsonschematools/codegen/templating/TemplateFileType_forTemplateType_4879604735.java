...
public class TemplateFileType_forTemplateType_4879604735 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public TemplateFileType_forTemplateType_4879604735() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "PkWMRdJcBb";
        callMethod(klass, "forTemplateType", argTypes, null, args);
    }
