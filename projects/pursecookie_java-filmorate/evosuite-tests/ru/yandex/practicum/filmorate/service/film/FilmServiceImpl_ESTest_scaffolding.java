...
public class FilmServiceImpl_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "ru.yandex.practicum.filmorate.service.film.FilmServiceImpl"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(FilmServiceImpl_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.sql.Connection", false, FilmServiceImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.Date", false, FilmServiceImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.PreparedStatement", false, FilmServiceImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.ResultSet", false, FilmServiceImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.Statement", false, FilmServiceImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("javax.sql.DataSource", false, FilmServiceImpl_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(FilmServiceImpl_ESTest_scaffolding.class.getClassLoader()); 
