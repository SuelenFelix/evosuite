...
public class UserDataService_getUserByExtId_13331471032 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public UserDataService_getUserByExtId_13331471032() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "OWDIEULEFu";
        callMethod(klass, "getUserByExtId", argTypes, null, args);
    }
