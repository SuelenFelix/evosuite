...
public class PasswordRecoveryDto_getEmail_8417827641 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term1;

    public PasswordRecoveryDto_getEmail_8417827641() {
    }
    ...
    public void setup() throws Throwable {
        term1 = newInstance(Class.forName("ru.smartup.timetracker.dto.password.recovery.request.PasswordRecoveryDto"));
