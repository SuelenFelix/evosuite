...
public class FilmService_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.sql.Connection", false, FilmService_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.Date", false, FilmService_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.PreparedStatement", false, FilmService_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.ResultSet", false, FilmService_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.Statement", false, FilmService_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("javax.sql.DataSource", false, FilmService_ESTest_scaffolding.class.getClassLoader()));
  }
