...
public class GeometryColumnsSqlMmDao_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "mil.nga.geopackage.features.columns.GeometryColumnsSqlMmDao"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(GeometryColumnsSqlMmDao_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.j256.ormlite.db.DatabaseType", false, GeometryColumnsSqlMmDao_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.j256.ormlite.support.ConnectionSource", false, GeometryColumnsSqlMmDao_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("mil.nga.geopackage.GeoPackageCore", false, GeometryColumnsSqlMmDao_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("mil.nga.geopackage.db.GeoPackageCoreConnection", false, GeometryColumnsSqlMmDao_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(GeometryColumnsSqlMmDao_ESTest_scaffolding.class.getClassLoader()); 
