...
public class DsnCreate_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "zowe.client.sdk.zosfiles.dsn.methods.DsnCreate"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DsnCreate_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "zowe.client.sdk.zosfiles.dsn.input.DsnCreateInputData",
      ...
      "zowe.client.sdk.zosfiles.dsn.input.DsnCreateInputData$Builder",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("zowe.client.sdk.core.ZosConnection", false, DsnCreate_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("zowe.client.sdk.zosfiles.dsn.input.DsnCreateInputData", false, DsnCreate_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DsnCreate_ESTest_scaffolding.class.getClassLoader()); 
