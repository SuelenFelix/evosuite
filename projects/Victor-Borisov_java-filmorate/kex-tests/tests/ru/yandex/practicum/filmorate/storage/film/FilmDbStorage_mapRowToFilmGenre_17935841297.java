...
public class FilmDbStorage_mapRowToFilmGenre_17935841297 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public FilmDbStorage_mapRowToFilmGenre_17935841297() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        callMethod(klass, "mapRowToFilmGenre", argTypes, null, args);
    }
