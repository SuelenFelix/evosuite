...
public class FileBO_FileBOBuilder_bucket_38597202615 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term3598;

    public FileBO_FileBOBuilder_bucket_38597202615() {
    }
    ...
    public void setup() throws Throwable {
        term3598 = newInstance(Class.forName("net.jaggerwang.sbip.entity.FileBO$FileBOBuilder"));
