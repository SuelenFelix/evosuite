...
public class CharDistributionAnalysis_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.mozilla.universalchardet.prober.distributionanalysis.CharDistributionAnalysis"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CharDistributionAnalysis_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CharDistributionAnalysis_ESTest_scaffolding.class.getClassLoader()); 
