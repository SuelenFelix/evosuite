...
public class AirdropMetadataController_airdrops_12162678341 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public AirdropMetadataController_airdrops_12162678341() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "EGtDIRbSSb";
        callMethod(klass, "airdrops", argTypes, null, args);
    }
