...
public class UpdateUserUseCaseService_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.alkemy.ong.application.service.user.UpdateUserUseCaseService"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(UpdateUserUseCaseService_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.alkemy.ong.application.service.user.usecase.IUpdateUserUseCase",
      ...
      "com.alkemy.ong.application.service.user.UpdateUserUseCaseService",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.alkemy.ong.infrastructure.database.repository.abstraction.IUserSpringRepository", false, UpdateUserUseCaseService_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(UpdateUserUseCaseService_ESTest_scaffolding.class.getClassLoader()); 
