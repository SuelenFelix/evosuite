...
public class CustomIntegrationDeserializer_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.scaleguard.server.kafka.deserializer.CustomIntegrationDeserializer"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CustomIntegrationDeserializer_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.scaleguard.server.kafka.deserializer.CustomIntegrationDeserializer",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CustomIntegrationDeserializer_ESTest_scaffolding.class.getClassLoader()); 
