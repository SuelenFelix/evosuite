...
public class UserStorageDaoImpl_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "ru.yandex.practicum.filmorate.dao.user.UserStorageDaoImpl"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(UserStorageDaoImpl_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.sql.Connection", false, UserStorageDaoImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.DatabaseMetaData", false, UserStorageDaoImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.ParameterMetaData", false, UserStorageDaoImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.PreparedStatement", false, UserStorageDaoImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("javax.sql.DataSource", false, UserStorageDaoImpl_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(UserStorageDaoImpl_ESTest_scaffolding.class.getClassLoader()); 
