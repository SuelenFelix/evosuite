...
public class DataServiceImpl_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "ru.yandex.practicum.filmorate.service.DataServiceImpl"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DataServiceImpl_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.sql.Connection", false, DataServiceImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.PreparedStatement", false, DataServiceImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.ResultSet", false, DataServiceImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.Statement", false, DataServiceImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("javax.sql.DataSource", false, DataServiceImpl_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DataServiceImpl_ESTest_scaffolding.class.getClassLoader()); 
