...
public class PathParser_containsAntTokens_6781442375 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public PathParser_containsAntTokens_6781442375() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "MuLcgQHgqz";
        callMethod(klass, "containsAntTokens", argTypes, null, args);
    }
