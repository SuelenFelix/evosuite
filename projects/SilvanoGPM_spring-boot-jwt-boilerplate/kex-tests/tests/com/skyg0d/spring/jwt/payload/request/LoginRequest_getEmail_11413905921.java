...
public class LoginRequest_getEmail_11413905921 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term1;

    public LoginRequest_getEmail_11413905921() {
    }
    ...
    public void setup() throws Throwable {
        term1 = newInstance(Class.forName("com.skyg0d.spring.jwt.payload.request.LoginRequest"));
