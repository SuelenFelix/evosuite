...
public class DanMuExportType_getEnumByValue_9147064634 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public DanMuExportType_getEnumByValue_9147064634() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "pCTimMblYc";
        callMethod(klass, "getEnumByValue", argTypes, null, args);
    }
