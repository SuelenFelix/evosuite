...
public class ContactConfirmationEmailTemplate_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.alkemy.ong.application.util.mail.template.ContactConfirmationEmailTemplate"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ContactConfirmationEmailTemplate_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.alkemy.ong.domain.Slide", false, ContactConfirmationEmailTemplate_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ContactConfirmationEmailTemplate_ESTest_scaffolding.class.getClassLoader()); 
