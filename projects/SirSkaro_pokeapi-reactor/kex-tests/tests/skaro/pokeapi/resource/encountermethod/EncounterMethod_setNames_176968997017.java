...
public class EncounterMethod_setNames_176968997017 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term378;

    public EncounterMethod_setNames_176968997017() {
    }
    ...
    public void setup() throws Throwable {
        term378 = newInstance(Class.forName("skaro.pokeapi.resource.encountermethod.EncounterMethod"));
        setField(term378, term378.getClass(), "id", null);
        setField(term378, term378.getClass(), "name", null);
        setField(term378, term378.getClass(), "order", null);
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        callMethod(klass, "setNames", argTypes, term378, args);
    }
