...
public class Example_fivePercentRaise_3171417756 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term57;

    public Example_fivePercentRaise_3171417756() {
    }
    ...
    public void setup() throws Throwable {
        term57 = newInstance(Class.forName("refactoring.app.chapter11.parameterizeFunction.Example"));
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        callMethod(klass, "fivePercentRaise", argTypes, term57, args);
    }
