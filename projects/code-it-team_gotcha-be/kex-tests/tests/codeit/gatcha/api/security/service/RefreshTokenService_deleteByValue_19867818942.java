...
public class RefreshTokenService_deleteByValue_19867818942 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public RefreshTokenService_deleteByValue_19867818942() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "RkybSrpybU";
        callMethod(klass, "deleteByValue", argTypes, null, args);
    }
