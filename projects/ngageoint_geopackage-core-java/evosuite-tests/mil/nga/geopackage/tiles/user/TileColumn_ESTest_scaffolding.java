...
public class TileColumn_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "mil.nga.geopackage.tiles.user.TileColumn"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(TileColumn_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.j256.ormlite.support.ConnectionSource", false, TileColumn_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("mil.nga.geopackage.db.table.TableColumn", false, TileColumn_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.locationtech.proj4j.proj.Projection", false, TileColumn_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(TileColumn_ESTest_scaffolding.class.getClassLoader()); 
