...
public class IntruderAttackOptions_fromSettings_11903738801 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public IntruderAttackOptions_fromSettings_11903738801() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        callMethod(klass, "fromSettings", argTypes, null, args);
    }
