...
public class UssChangeMode_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "zowe.client.sdk.zosfiles.uss.methods.UssChangeMode"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(UssChangeMode_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "zowe.client.sdk.zosfiles.uss.input.UssChangeModeInputData$Builder",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("zowe.client.sdk.core.ZosConnection", false, UssChangeMode_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(UssChangeMode_ESTest_scaffolding.class.getClassLoader()); 
