...
public class AirdropMetadataController_scheduled_123948643613 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public AirdropMetadataController_scheduled_123948643613() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "scheduled", argTypes, null, args);
    }
