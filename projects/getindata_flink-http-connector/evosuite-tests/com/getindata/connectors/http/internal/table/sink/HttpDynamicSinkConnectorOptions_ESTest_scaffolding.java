...
public class HttpDynamicSinkConnectorOptions_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.getindata.connectors.http.internal.table.sink.HttpDynamicSinkConnectorOptions"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(HttpDynamicSinkConnectorOptions_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(HttpDynamicSinkConnectorOptions_ESTest_scaffolding.class.getClassLoader()); 
