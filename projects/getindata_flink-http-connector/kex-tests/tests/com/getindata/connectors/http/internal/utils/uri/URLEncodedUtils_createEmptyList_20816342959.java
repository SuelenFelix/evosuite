...
public class URLEncodedUtils_createEmptyList_20816342959 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public URLEncodedUtils_createEmptyList_20816342959() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "createEmptyList", argTypes, null, args);
    }
