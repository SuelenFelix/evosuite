...
public class PokemonSpeciesVariety_getPokemon_10588395063 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term99;

    public PokemonSpeciesVariety_getPokemon_10588395063() {
    }
    ...
    public void setup() throws Throwable {
        Boolean term100 = new Boolean(false);
        term99 = newInstance(Class.forName("skaro.pokeapi.resource.pokemonspecies.PokemonSpeciesVariety"));
        Object term102 = newInstance(Class.forName("skaro.pokeapi.resource.NamedApiResource"));
        setField(term99, term99.getClass(), "isDefault", term100);
