...
public class Mating_addNodesAndConnections_6399831375 {
    ...
    public void setup() throws Throwable {
        ...
        setLongField(term2380, term2380.getClass(), "value", 40700899752565L);
        ...
        setLongField(term2429, term2429.getClass(), "value", 272884825500753L);
        ...
        Class<? extends Object> term2562 = Class.forName((String) "nn.model.Type");
        Field term2561 = ((Class) term2562).getDeclaredField((String) "SENSOR");
        ((Field) term2561).setAccessible(true);
        Object enum12 = ((Field) term2561).get((Object) null);
        ArrayList term2532 = new ArrayList();
        Object term2541 = newInstance(Class.forName("nn.model.Connection"));
        setField(term2541, term2541.getClass(), "in", null);
        setField(term2541, term2541.getClass(), "out", null);
        setFloatField(term2541, term2541.getClass(), "weight", 0.18330246F);
        setBooleanField(term2541, term2541.getClass(), "expressed", false);
        setIntField(term2541, term2541.getClass(), "innovation", 808614267);
        Object term2545 = newInstance(Class.forName("nn.model.Connection"));
        setField(term2545, term2545.getClass(), "in", null);
        setField(term2545, term2545.getClass(), "out", null);
        setFloatField(term2545, term2545.getClass(), "weight", 0.0F);
        setBooleanField(term2545, term2545.getClass(), "expressed", false);
        setIntField(term2545, term2545.getClass(), "innovation", 0);
        Object term2549 = newInstance(Class.forName("nn.model.Connection"));
        setField(term2549, term2549.getClass(), "in", null);
        setField(term2549, term2549.getClass(), "out", null);
        setFloatField(term2549, term2549.getClass(), "weight", 0.0F);
        setBooleanField(term2549, term2549.getClass(), "expressed", false);
        setIntField(term2549, term2549.getClass(), "innovation", 0);
        ArrayList term2539 = new ArrayList();
        ((ArrayList) term2539).add(term2541);
        ((ArrayList) term2539).add(term2545);
        ((ArrayList) term2539).add(term2549);
        term2529 = newInstance(Class.forName("nn.model.Connection"));
        Object term2530 = newInstance(Class.forName("nn.model.Node"));
        Object term2537 = newInstance(Class.forName("nn.model.Node"));
        setField(term2530, term2530.getClass(), "type", enum12);
        setIntField(term2530, term2530.getClass(), "innovation", -1608123016);
        setField(term2530, term2530.getClass(), "connections", term2532);
        setDoubleField(term2530, term2530.getClass(), "bias", 0.8046904246652031);
        setField(term2529, term2529.getClass(), "in", term2530);
        setField(term2537, term2537.getClass(), "type", enum12);
        setIntField(term2537, term2537.getClass(), "innovation", -896473214);
        setField(term2537, term2537.getClass(), "connections", term2539);
        setDoubleField(term2537, term2537.getClass(), "bias", 0.3142783864669928);
        setField(term2529, term2529.getClass(), "out", term2537);
        setFloatField(term2529, term2529.getClass(), "weight", 0.51947397F);
        setBooleanField(term2529, term2529.getClass(), "expressed", true);
        setIntField(term2529, term2529.getClass(), "innovation", 1611734632);
        term2559 = new Boolean(true);
    }
