...
public class ClusteringAlgorithmProvider_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.nlpub.watset.util.ClusteringAlgorithmProvider"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ClusteringAlgorithmProvider_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.nlpub.watset.util.ClusteringAlgorithmProvider$1",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.jgrapht.Graph", false, ClusteringAlgorithmProvider_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jgrapht.GraphType", false, ClusteringAlgorithmProvider_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ClusteringAlgorithmProvider_ESTest_scaffolding.class.getClassLoader()); 
