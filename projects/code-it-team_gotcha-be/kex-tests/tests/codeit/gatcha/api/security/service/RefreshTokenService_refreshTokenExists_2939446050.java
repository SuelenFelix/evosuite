...
public class RefreshTokenService_refreshTokenExists_2939446050 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public RefreshTokenService_refreshTokenExists_2939446050() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "sjlJAEtRrb";
        callMethod(klass, "refreshTokenExists", argTypes, null, args);
    }
