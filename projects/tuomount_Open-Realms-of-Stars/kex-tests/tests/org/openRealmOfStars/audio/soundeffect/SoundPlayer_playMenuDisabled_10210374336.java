...
public class SoundPlayer_playMenuDisabled_10210374336 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public SoundPlayer_playMenuDisabled_10210374336() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "playMenuDisabled", argTypes, null, args);
    }
