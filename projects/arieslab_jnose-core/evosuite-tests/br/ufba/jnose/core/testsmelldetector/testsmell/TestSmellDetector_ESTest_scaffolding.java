...
public class TestSmellDetector_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "br.ufba.jnose.core.testsmelldetector.testsmell.TestSmellDetector"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(TestSmellDetector_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "br.ufba.jnose.core.testsmelldetector.testsmell.TestSmellDetector",
      ...
      "br.ufba.jnose.core.testsmelldetector.testsmell.TestFile",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("br.ufba.jnose.core.Config", false, TestSmellDetector_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(TestSmellDetector_ESTest_scaffolding.class.getClassLoader()); 
