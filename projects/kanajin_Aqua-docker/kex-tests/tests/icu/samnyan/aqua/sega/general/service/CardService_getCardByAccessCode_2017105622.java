...
public class CardService_getCardByAccessCode_2017105622 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public CardService_getCardByAccessCode_2017105622() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "EGtDIRbSSb";
        callMethod(klass, "getCardByAccessCode", argTypes, null, args);
    }
