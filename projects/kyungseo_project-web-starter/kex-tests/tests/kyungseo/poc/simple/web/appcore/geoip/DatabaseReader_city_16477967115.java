...
public class DatabaseReader_city_16477967115 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term115;

    public DatabaseReader_city_16477967115() {
    }
    ...
    public void setup() throws Throwable {
        term115 = newInstance(Class.forName("kyungseo.poc.simple.web.appcore.geoip.DatabaseReader"));
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        callMethod(klass, "city", argTypes, term115, args);
    }
