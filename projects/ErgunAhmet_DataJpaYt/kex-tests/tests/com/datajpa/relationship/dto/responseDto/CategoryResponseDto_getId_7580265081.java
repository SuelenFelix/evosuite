...
public class CategoryResponseDto_getId_7580265081 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term1;

    public CategoryResponseDto_getId_7580265081() {
    }
    ...
    public void setup() throws Throwable {
        ...
        ((ArrayList) term16).add("EGtDIRbSSb");
        term1 = newInstance(Class.forName("com.datajpa.relationship.dto.responseDto.CategoryResponseDto"));
        setField(term1, term1.getClass(), "id", term2);
        setField(term1, term1.getClass(), "name", "PAEBtnZtTD");
        setField(term1, term1.getClass(), "bookNames", term16);
    }
