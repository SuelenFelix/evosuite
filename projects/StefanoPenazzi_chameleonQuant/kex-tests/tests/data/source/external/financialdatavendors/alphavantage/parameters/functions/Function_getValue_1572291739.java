...
public class Function_getValue_1572291739 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object enum5;

    public Function_getValue_1572291739() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term3974 = Class.forName((String) "data.source.external.financialdatavendors.alphavantage.parameters.functions.Function");
        Field term3973 = ((Class) term3974).getDeclaredField((String) "AROONOSC");
        ((Field) term3973).setAccessible(true);
        enum5 = ((Field) term3973).get((Object) null);
    }
