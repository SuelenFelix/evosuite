...
public class FriendshipService_init_1669442585 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public FriendshipService_init_1669442585() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        argTypes[0] = Class.forName("ru.yandex.practicum.filmorate.dao.friendship.FriendshipStorageDao");
