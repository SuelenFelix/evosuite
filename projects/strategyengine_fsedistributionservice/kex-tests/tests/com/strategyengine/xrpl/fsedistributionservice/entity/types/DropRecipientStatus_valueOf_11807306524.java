...
public class DropRecipientStatus_valueOf_11807306524 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object enum1;

    public DropRecipientStatus_valueOf_11807306524() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term491 = Class.forName((String) "com.strategyengine.xrpl.fsedistributionservice.entity.types.DropRecipientStatus");
        Field term490 = ((Class) term491).getDeclaredField((String) "SENDING");
        ((Field) term490).setAccessible(true);
        enum1 = ((Field) term490).get((Object) null);
    }
