...
public class AemTestClassFinder_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "ix.ibm.sonar.java.visitors.AemTestClassFinder"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AemTestClassFinder_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "ix.ibm.sonar.java.visitors.AemTestClassFinder",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.sonar.plugins.java.api.semantic.Symbol$TypeSymbol", false, AemTestClassFinder_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sonar.plugins.java.api.semantic.SymbolMetadata", false, AemTestClassFinder_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sonar.plugins.java.api.semantic.Type", false, AemTestClassFinder_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sonar.plugins.java.api.tree.BinaryExpressionTree", false, AemTestClassFinder_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sonar.plugins.java.api.tree.ClassTree", false, AemTestClassFinder_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sonar.plugins.java.api.tree.Tree", false, AemTestClassFinder_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AemTestClassFinder_ESTest_scaffolding.class.getClassLoader()); 
