...
public class UserCustomTableReader_createColumn_2088278983 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term1267;

    public UserCustomTableReader_createColumn_2088278983() {
    }
    ...
    public void setup() throws Throwable {
        term1267 = newInstance(Class.forName("mil.nga.geopackage.user.custom.UserCustomTableReader"));
