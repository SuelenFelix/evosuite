...
public class AnnotationType_valueOf_6218673966 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object enum11;

    public AnnotationType_valueOf_6218673966() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term6270 = Class.forName((String) "org.openapijsonschematools.codegen.generators.generatormetadata.features.annotations.AnnotationType");
        Field term6269 = ((Class) term6270).getDeclaredField((String) "OAS2");
        ((Field) term6269).setAccessible(true);
        enum11 = ((Field) term6269).get((Object) null);
    }
