...
public class History_hasChina_4359707851 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term95;

    public History_hasChina_4359707851() {
    }
    ...
    public void setup() throws Throwable {
        ...
        term95 = newInstance(Class.forName("refactoring.app.chapter10.replaceConditionalWithPolymorphism.example2.History"));
        setField(term95, term95.getClass(), "voyages", term96);
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "hasChina", argTypes, term95, args);
    }
