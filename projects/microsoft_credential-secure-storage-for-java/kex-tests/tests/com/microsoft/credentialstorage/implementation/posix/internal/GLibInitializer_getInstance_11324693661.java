...
public class GLibInitializer_getInstance_11324693661 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public GLibInitializer_getInstance_11324693661() {
    }
    ...
    public void test() throws Throwable, Throwable {
        Class<?> klass = Class.forName("com.microsoft.credentialstorage.implementation.posix.internal.GLibInitializer");
