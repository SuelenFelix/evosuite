...
public class Slice_valueOf_20741652126 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object enum9;

    public Slice_valueOf_20741652126() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term5448 = Class.forName((String) "data.source.external.financialdatavendors.alphavantage.parameters.intradaytimeseries.Slice");
        Field term5447 = ((Class) term5448).getDeclaredField((String) "YEAR2MONTH8");
        ((Field) term5447).setAccessible(true);
        enum9 = ((Field) term5447).get((Object) null);
    }
