...
public class Endpoints_isEmpty_28796948011 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term52;

    public Endpoints_isEmpty_28796948011() {
    }
    ...
    public void setup() throws Throwable {
        term52 = newInstance(Class.forName("be.tomcools.dropwizard.websocket.registration.Endpoints"));
        setField(term52, term52.getClass(), "endpointList", null);
    }
