...
CSV_FILE = "coverage_native_evosuite.csv"
...
def process_project(project_path):
    ...
    project_csv = project_path / "coverage_native_evosuite.csv"
    log_file = project_path / "coverage_native_evosuite.log"
