...
public class BerryFirmness_getId_134355449310 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term394;

    public BerryFirmness_getId_134355449310() {
    }
    ...
    public void setup() throws Throwable {
        term394 = newInstance(Class.forName("skaro.pokeapi.resource.berryfirmness.BerryFirmness"));
        setField(term394, term394.getClass(), "id", null);
        setField(term394, term394.getClass(), "name", null);
        setField(term394, term394.getClass(), "berries", null);
