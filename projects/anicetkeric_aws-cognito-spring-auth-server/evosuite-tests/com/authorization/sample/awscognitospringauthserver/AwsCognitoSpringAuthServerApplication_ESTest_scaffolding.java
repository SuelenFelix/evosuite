...
public class AwsCognitoSpringAuthServerApplication_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.authorization.sample.awscognitospringauthserver.AwsCognitoSpringAuthServerApplication"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AwsCognitoSpringAuthServerApplication_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.authorization.sample.awscognitospringauthserver.AwsCognitoSpringAuthServerApplication",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AwsCognitoSpringAuthServerApplication_ESTest_scaffolding.class.getClassLoader()); 
