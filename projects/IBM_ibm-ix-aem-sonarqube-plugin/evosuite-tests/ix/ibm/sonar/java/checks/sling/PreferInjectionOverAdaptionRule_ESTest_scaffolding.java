...
public class PreferInjectionOverAdaptionRule_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "ix.ibm.sonar.java.checks.sling.PreferInjectionOverAdaptionRule"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(PreferInjectionOverAdaptionRule_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.sonar.plugins.java.api.JavaFileScannerContext", false, PreferInjectionOverAdaptionRule_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sonar.plugins.java.api.semantic.Symbol", false, PreferInjectionOverAdaptionRule_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sonar.plugins.java.api.semantic.Symbol$TypeSymbol", false, PreferInjectionOverAdaptionRule_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sonar.plugins.java.api.semantic.Type", false, PreferInjectionOverAdaptionRule_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sonar.plugins.java.api.tree.IdentifierTree", false, PreferInjectionOverAdaptionRule_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sonar.plugins.java.api.tree.SyntaxToken", false, PreferInjectionOverAdaptionRule_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(PreferInjectionOverAdaptionRule_ESTest_scaffolding.class.getClassLoader()); 
