...
public class ReflectedTestCase_init_11011315779 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public ReflectedTestCase_init_11011315779() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        argTypes[0] = Class.forName("com.github.nylle.javafixture.annotations.testcases.TestCase");
