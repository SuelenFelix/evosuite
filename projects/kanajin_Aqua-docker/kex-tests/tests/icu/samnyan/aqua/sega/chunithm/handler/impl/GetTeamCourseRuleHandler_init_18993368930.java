...
public class GetTeamCourseRuleHandler_init_18993368930 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public GetTeamCourseRuleHandler_init_18993368930() {
    }
    ...
    public void test() throws Throwable, Throwable {
        Class<?> klass = Class.forName("icu.samnyan.aqua.sega.chunithm.handler.impl.GetTeamCourseRuleHandler");
