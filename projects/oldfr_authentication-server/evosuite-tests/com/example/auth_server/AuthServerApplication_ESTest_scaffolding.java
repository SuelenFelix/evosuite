...
public class AuthServerApplication_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.example.auth_server.AuthServerApplication"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AuthServerApplication_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.example.auth_server.AuthServerApplication",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AuthServerApplication_ESTest_scaffolding.class.getClassLoader()); 
