...
public class FlowException_getFlowConcerned_16357329201 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public FlowException_getFlowConcerned_16357329201() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "getFlowConcerned", argTypes, null, args);
    }
