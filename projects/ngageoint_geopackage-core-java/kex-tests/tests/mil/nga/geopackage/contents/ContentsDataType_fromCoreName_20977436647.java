...
public class ContentsDataType_fromCoreName_20977436647 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public ContentsDataType_fromCoreName_20977436647() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "xxtlPwDYFs";
        callMethod(klass, "fromCoreName", argTypes, null, args);
    }
