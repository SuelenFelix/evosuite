...
public class FOREXIDTimeSeriesPointInfluxdb_getLow_45261133012 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term102;

    public FOREXIDTimeSeriesPointInfluxdb_getLow_45261133012() {
    }
    ...
    public void setup() throws Throwable {
        term102 = newInstance(Class.forName("data.source.external.database.influxdb.mirrors.FOREXIDTimeSeriesPointInfluxdb"));
