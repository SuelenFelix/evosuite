...
public class AdminServicesImpl_getAdminByEmail_12062721634 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public AdminServicesImpl_getAdminByEmail_12062721634() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "uuaPigETmJ";
        callMethod(klass, "getAdminByEmail", argTypes, null, args);
    }
