...
public class Interval_getValue_17032431899 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object enum5;

    public Interval_getValue_17032431899() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term2688 = Class.forName((String) "data.source.external.financialdatavendors.alphavantage.parameters.intradaytimeseries.Interval");
        Field term2687 = ((Class) term2688).getDeclaredField((String) "SIXTY_MIN");
        ((Field) term2687).setAccessible(true);
        enum5 = ((Field) term2687).get((Object) null);
    }
