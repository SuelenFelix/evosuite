...
public class DanMuMessageType_getEnumByText_8157771113 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public DanMuMessageType_getEnumByText_8157771113() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "xLbjWUgOIL";
        callMethod(klass, "getEnumByText", argTypes, null, args);
    }
