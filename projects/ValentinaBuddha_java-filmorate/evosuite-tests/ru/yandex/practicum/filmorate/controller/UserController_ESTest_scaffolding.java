...
public class UserController_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "ru.yandex.practicum.filmorate.controller.UserController"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.sql.Connection", false, UserController_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.Date", false, UserController_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.PreparedStatement", false, UserController_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.ResultSet", false, UserController_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.Statement", false, UserController_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("javax.sql.DataSource", false, UserController_ESTest_scaffolding.class.getClassLoader()));
  }
