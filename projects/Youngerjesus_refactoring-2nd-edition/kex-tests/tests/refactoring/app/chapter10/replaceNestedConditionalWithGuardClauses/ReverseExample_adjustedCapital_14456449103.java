...
public class ReverseExample_adjustedCapital_14456449103 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term8;

    public ReverseExample_adjustedCapital_14456449103() {
    }
    ...
    public void setup() throws Throwable {
        term8 = newInstance(Class.forName("refactoring.app.chapter10.replaceNestedConditionalWithGuardClauses.ReverseExample"));
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        callMethod(klass, "adjustedCapital", argTypes, term8, args);
    }
