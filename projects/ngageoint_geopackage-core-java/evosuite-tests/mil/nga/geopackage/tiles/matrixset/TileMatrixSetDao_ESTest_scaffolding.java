...
public class TileMatrixSetDao_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "mil.nga.geopackage.tiles.matrixset.TileMatrixSetDao"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(TileMatrixSetDao_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.j256.ormlite.stmt.mapped.MappedQueryForFieldEq",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.j256.ormlite.db.DatabaseType", false, TileMatrixSetDao_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.j256.ormlite.support.ConnectionSource", false, TileMatrixSetDao_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("mil.nga.geopackage.GeoPackageCore", false, TileMatrixSetDao_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("mil.nga.geopackage.db.GeoPackageCoreConnection", false, TileMatrixSetDao_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(TileMatrixSetDao_ESTest_scaffolding.class.getClassLoader()); 
