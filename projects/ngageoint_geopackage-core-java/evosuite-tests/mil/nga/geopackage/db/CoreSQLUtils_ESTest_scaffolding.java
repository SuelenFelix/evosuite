...
public class CoreSQLUtils_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "mil.nga.geopackage.db.CoreSQLUtils"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CoreSQLUtils_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.j256.ormlite.support.ConnectionSource", false, CoreSQLUtils_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("mil.nga.geopackage.db.GeoPackageCoreConnection", false, CoreSQLUtils_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CoreSQLUtils_ESTest_scaffolding.class.getClassLoader()); 
