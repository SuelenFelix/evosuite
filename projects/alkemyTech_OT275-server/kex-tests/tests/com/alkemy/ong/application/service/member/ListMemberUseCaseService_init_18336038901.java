...
public class ListMemberUseCaseService_init_18336038901 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public ListMemberUseCaseService_init_18336038901() {
    }
    ...
    public void test() throws Throwable, Throwable {
        Class<?> klass = Class.forName("com.alkemy.ong.application.service.member.ListMemberUseCaseService");
