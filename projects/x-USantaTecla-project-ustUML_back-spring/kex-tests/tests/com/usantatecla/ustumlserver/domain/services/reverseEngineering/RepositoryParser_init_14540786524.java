...
public class RepositoryParser_init_14540786524 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public RepositoryParser_init_14540786524() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        argTypes[0] = Class.forName("com.usantatecla.ustumlserver.domain.persistence.MemberPersistence");
