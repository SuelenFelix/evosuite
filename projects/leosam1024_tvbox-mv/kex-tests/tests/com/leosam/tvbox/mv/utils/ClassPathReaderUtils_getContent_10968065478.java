...
public class ClassPathReaderUtils_getContent_10968065478 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public ClassPathReaderUtils_getContent_10968065478() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "ffYhPOzlUs";
        callMethod(klass, "getContent", argTypes, null, args);
    }
