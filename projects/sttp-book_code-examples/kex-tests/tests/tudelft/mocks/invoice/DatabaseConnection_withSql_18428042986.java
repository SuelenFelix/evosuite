...
public class DatabaseConnection_withSql_18428042986 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term2953;

    public DatabaseConnection_withSql_18428042986() {
    }
    ...
    public void setup() throws Throwable {
        term2953 = newInstance(Class.forName("tudelft.mocks.invoice.DatabaseConnection"));
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        callMethod(klass, "withSql", argTypes, term2953, args);
    }
