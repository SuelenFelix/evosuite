...
public class ShutdownListenerThread_init_937039500 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public ShutdownListenerThread_init_937039500() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        argTypes[0] = Class.forName("com.rtbhouse.kafka.workers.impl.KafkaWorkersImpl");
