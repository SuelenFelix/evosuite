...
public class ExampleService_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.fasterxml.jackson.databind.deser.DefaultDeserializationContext", false, ExampleService_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.databind.ser.DefaultSerializerProvider", false, ExampleService_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.databind.type.TypeModifier", false, ExampleService_ESTest_scaffolding.class.getClassLoader()));
  }
