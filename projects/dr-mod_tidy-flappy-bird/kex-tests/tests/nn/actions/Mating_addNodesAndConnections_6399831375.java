...
public class Mating_addNodesAndConnections_6399831375 {
    ...
    public void setup() throws Throwable {
        ...
        setLongField(term2380, term2380.getClass(), "value", 153152620740847L);
        ...
        setLongField(term2429, term2429.getClass(), "value", 94974715130795L);
        ...
        Class<? extends Object> term2554 = Class.forName((String) "nn.model.Type");
        Field term2553 = ((Class) term2554).getDeclaredField((String) "SENSOR");
        ((Field) term2553).setAccessible(true);
        Object enum12 = ((Field) term2553).get((Object) null);
        ArrayList term2524 = new ArrayList();
        Object term2533 = newInstance(Class.forName("nn.model.Connection"));
        setField(term2533, term2533.getClass(), "in", null);
        setField(term2533, term2533.getClass(), "out", null);
        setFloatField(term2533, term2533.getClass(), "weight", 0.18330246F);
        setBooleanField(term2533, term2533.getClass(), "expressed", false);
        setIntField(term2533, term2533.getClass(), "innovation", 808614267);
        Object term2537 = newInstance(Class.forName("nn.model.Connection"));
        setField(term2537, term2537.getClass(), "in", null);
        setField(term2537, term2537.getClass(), "out", null);
        setFloatField(term2537, term2537.getClass(), "weight", 0.0F);
        setBooleanField(term2537, term2537.getClass(), "expressed", false);
        setIntField(term2537, term2537.getClass(), "innovation", 0);
        ...
        setFloatField(term2541, term2541.getClass(), "weight", 0.0F);
        setBooleanField(term2541, term2541.getClass(), "expressed", false);
        setIntField(term2541, term2541.getClass(), "innovation", 0);
        ArrayList term2531 = new ArrayList();
        ((ArrayList) term2531).add(term2533);
        ((ArrayList) term2531).add(term2537);
        ((ArrayList) term2531).add(term2541);
        term2521 = newInstance(Class.forName("nn.model.Connection"));
        Object term2522 = newInstance(Class.forName("nn.model.Node"));
        Object term2529 = newInstance(Class.forName("nn.model.Node"));
        setField(term2522, term2522.getClass(), "type", enum12);
        setIntField(term2522, term2522.getClass(), "innovation", -1608123016);
        setField(term2522, term2522.getClass(), "connections", term2524);
        setDoubleField(term2522, term2522.getClass(), "bias", 0.8046904246652031);
        setField(term2521, term2521.getClass(), "in", term2522);
        setField(term2529, term2529.getClass(), "type", enum12);
        setIntField(term2529, term2529.getClass(), "innovation", -896473214);
        setField(term2529, term2529.getClass(), "connections", term2531);
        setDoubleField(term2529, term2529.getClass(), "bias", 0.3142783864669928);
        setField(term2521, term2521.getClass(), "out", term2529);
        setFloatField(term2521, term2521.getClass(), "weight", 0.51947397F);
        setBooleanField(term2521, term2521.getClass(), "expressed", true);
        setIntField(term2521, term2521.getClass(), "innovation", 1611734632);
        term2551 = new Boolean(true);
    }
