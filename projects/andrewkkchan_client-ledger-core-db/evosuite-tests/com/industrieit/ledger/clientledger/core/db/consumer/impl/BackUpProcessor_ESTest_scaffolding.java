...
public class BackUpProcessor_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.industrieit.ledger.clientledger.core.db.consumer.impl.BackUpProcessor"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(BackUpProcessor_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.industrieit.ledger.clientledger.core.db.consumer.impl.BackUpProcessor",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.fasterxml.jackson.databind.ser.DefaultSerializerProvider", false, BackUpProcessor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.industrieit.ledger.clientledger.core.db.repository.TransactionResultRepository", false, BackUpProcessor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.kafka.clients.producer.Producer", false, BackUpProcessor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.springframework.kafka.core.ProducerFactory", false, BackUpProcessor_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(BackUpProcessor_ESTest_scaffolding.class.getClassLoader()); 
