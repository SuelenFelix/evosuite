...
public class FileStorage_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.scaleguard.server.db.FileStorage"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(FileStorage_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.scaleguard.server.db.FileStorage",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(FileStorage_ESTest_scaffolding.class.getClassLoader()); 
