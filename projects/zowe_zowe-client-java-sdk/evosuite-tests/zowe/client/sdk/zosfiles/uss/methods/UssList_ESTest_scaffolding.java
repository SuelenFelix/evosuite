...
public class UssList_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "zowe.client.sdk.zosfiles.uss.methods.UssList"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(UssList_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "zowe.client.sdk.zosfiles.uss.input.UssListInputData$Builder",
      ...
      "zowe.client.sdk.zosfiles.uss.input.UssListInputData",
      ...
      "zowe.client.sdk.zosfiles.uss.response.UnixZfsListResponse",
      ...
      "zowe.client.sdk.zosfiles.uss.input.UssListZfsInputData$Builder",
      "com.fasterxml.jackson.databind.ser.std.NumberSerializers",
      "zowe.client.sdk.zosfiles.uss.response.UnixFileListResponse",
      ...
      "zowe.client.sdk.zosfiles.uss.types.ListFilterType"
    );
  } 
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("zowe.client.sdk.core.ZosConnection", false, UssList_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(UssList_ESTest_scaffolding.class.getClassLoader()); 
