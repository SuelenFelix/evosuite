...
public class AutoCacheInputService_getCacheSize_2797156642 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public AutoCacheInputService_getCacheSize_2797156642() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "MjGYSRKTNF";
        callMethod(klass, "getCacheSize", argTypes, null, args);
    }
