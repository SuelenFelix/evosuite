...
public class DanMuRecordController_stopAllTask_205864652113 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public DanMuRecordController_stopAllTask_205864652113() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "stopAllTask", argTypes, null, args);
    }
