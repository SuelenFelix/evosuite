...
public class SystemUtils_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.obvj.performetrics.util.SystemUtils"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.lang.management.ThreadMXBean", false, SystemUtils_ESTest_scaffolding.class.getClassLoader()));
  }
