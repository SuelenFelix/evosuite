...
public class AvroUtils_sanitizeColumnName_6163208601 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public AvroUtils_sanitizeColumnName_6163208601() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "PAEBtnZtTD";
        callMethod(klass, "sanitizeColumnName", argTypes, null, args);
    }
