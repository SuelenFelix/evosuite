...
public class Example_regularDeliveryDate_91974706 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term106;

    public Example_regularDeliveryDate_91974706() {
    }
    ...
    public void setup() throws Throwable {
        term106 = newInstance(Class.forName("refactoring.app.chapter11.removeFlagArgument.Example"));
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        callMethod(klass, "regularDeliveryDate", argTypes, term106, args);
    }
