...
public class Part_init_3567584361 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object enum21;

    public Part_init_3567584361() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term10905 = Class.forName((String) "org.openapijsonschematools.codegen.generatorrunner.ignore.rules.IgnoreLineParser$Token");
        Field term10904 = ((Class) term10905).getDeclaredField((String) "COMMENT");
        ((Field) term10904).setAccessible(true);
        enum21 = ((Field) term10904).get((Object) null);
    }
