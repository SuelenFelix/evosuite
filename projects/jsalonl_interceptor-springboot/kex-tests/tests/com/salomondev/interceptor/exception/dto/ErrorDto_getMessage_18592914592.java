...
public class ErrorDto_getMessage_18592914592 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term46;

    public ErrorDto_getMessage_18592914592() {
    }
    ...
    public void setup() throws Throwable {
        term46 = newInstance(Class.forName("com.salomondev.interceptor.exception.dto.ErrorDto"));
        setField(term46, term46.getClass(), "code", "MuLcgQHgqz");
