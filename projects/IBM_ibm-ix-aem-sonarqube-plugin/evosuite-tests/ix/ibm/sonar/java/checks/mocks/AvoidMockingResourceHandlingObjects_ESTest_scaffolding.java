...
public class AvoidMockingResourceHandlingObjects_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "ix.ibm.sonar.java.checks.mocks.AvoidMockingResourceHandlingObjects"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AvoidMockingResourceHandlingObjects_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.sonar.plugins.java.api.semantic.Type", false, AvoidMockingResourceHandlingObjects_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sonar.plugins.java.api.tree.ExpressionTree", false, AvoidMockingResourceHandlingObjects_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sonar.plugins.java.api.tree.MethodInvocationTree", false, AvoidMockingResourceHandlingObjects_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sonar.plugins.java.api.tree.TypeTree", false, AvoidMockingResourceHandlingObjects_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sonar.plugins.java.api.tree.VariableTree", false, AvoidMockingResourceHandlingObjects_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AvoidMockingResourceHandlingObjects_ESTest_scaffolding.class.getClassLoader()); 
