...
public class ClientModificationFeature_valueOf_19673282844 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object enum7;

    public ClientModificationFeature_valueOf_19673282844() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term3921 = Class.forName((String) "org.openapijsonschematools.codegen.generators.generatormetadata.features.ClientModificationFeature");
        Field term3920 = ((Class) term3921).getDeclaredField((String) "UserAgent");
        ((Field) term3920).setAccessible(true);
        enum7 = ((Field) term3920).get((Object) null);
    }
