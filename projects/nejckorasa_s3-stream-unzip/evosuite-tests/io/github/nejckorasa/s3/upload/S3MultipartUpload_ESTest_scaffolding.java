...
public class S3MultipartUpload_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "io.github.nejckorasa.s3.upload.S3MultipartUpload"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(S3MultipartUpload_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.amazonaws.services.s3.AmazonS3", false, S3MultipartUpload_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.amazonaws.services.s3.model.InitiateMultipartUploadResult", false, S3MultipartUpload_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.amazonaws.services.s3.model.UploadPartResult", false, S3MultipartUpload_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Function", false, S3MultipartUpload_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(S3MultipartUpload_ESTest_scaffolding.class.getClassLoader()); 
