...
public class StockApiApplication_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.victorlevin.TinkoffStockService.StockApiApplication"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(StockApiApplication_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.victorlevin.TinkoffStockService.StockApiApplication",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(StockApiApplication_ESTest_scaffolding.class.getClassLoader()); 
