...
public class Slice_getValue_8839917944 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object enum7;

    public Slice_getValue_8839917944() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term4461 = Class.forName((String) "data.source.external.financialdatavendors.alphavantage.parameters.intradaytimeseries.Slice");
        Field term4460 = ((Class) term4461).getDeclaredField((String) "YEAR1MONTH9");
        ((Field) term4460).setAccessible(true);
        enum7 = ((Field) term4460).get((Object) null);
    }
