...
public class MinecraftClient_ESTest extends MinecraftClient_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
          ...
          try { 
            MinecraftClient.connect("#>'eE)\"OKwD\"3<b", "Xo[", 4501);
          } catch(SecurityException e) {
             //
             // Security manager blocks (\"java.net.SocketPermission\" \"200.42.42.0:4501\" \"connect,resolve\")
  ...
  public void test1()  throws Throwable  {
      // Undeclared exception!
      try { 
        MinecraftClient.connect("com.google.common.collect.BoundType", "com.google.common.collect.BoundType", (-4245));
      } catch(IllegalArgumentException e) {
         //
         // port out of range:-4245
         //
