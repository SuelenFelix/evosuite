...
public class ProductService_init_5066117155 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public ProductService_init_5066117155() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        argTypes[0] = Class.forName("com.martinachov.hexagonal.application.ports.output.ProductOutputPort");
