...
public class HttpClientInitializer_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.scaleguard.server.http.client.HttpClientInitializer"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(HttpClientInitializer_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("io.netty.buffer.ByteBufAllocator", false, HttpClientInitializer_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("io.netty.channel.ChannelPipeline", false, HttpClientInitializer_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("io.netty.channel.socket.SocketChannel", false, HttpClientInitializer_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("io.netty.handler.ssl.SslContext", false, HttpClientInitializer_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("io.netty.handler.ssl.SslHandler", false, HttpClientInitializer_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(HttpClientInitializer_ESTest_scaffolding.class.getClassLoader()); 
