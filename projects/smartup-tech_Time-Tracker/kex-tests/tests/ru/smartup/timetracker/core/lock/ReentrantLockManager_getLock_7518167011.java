...
public class ReentrantLockManager_getLock_7518167011 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term1;

    public ReentrantLockManager_getLock_7518167011() {
    }
    ...
    public void setup() throws Throwable {
        term1 = newInstance(Class.forName("ru.smartup.timetracker.core.lock.ReentrantLockManager"));
        ...
        setField(term2, term2.getClass(), "keySet", null);
        setField(term2, term2.getClass(), "values", null);
        setField(term1, term1.getClass(), "locks", term2);
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "PAEBtnZtTD";
        callMethod(klass, "getLock", argTypes, term1, args);
    }
