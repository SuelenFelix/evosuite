...
public class AbstractFilesDanMuExportService_getLiveName_92792498134 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public AbstractFilesDanMuExportService_getLiveName_92792498134() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "getLiveName", argTypes, null, args);
    }
