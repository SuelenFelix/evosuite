...
public class FileBO_FileBOBuilder_id_91775854812 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term3595;

    public FileBO_FileBOBuilder_id_91775854812() {
    }
    ...
    public void setup() throws Throwable {
        term3595 = newInstance(Class.forName("net.jaggerwang.sbip.entity.FileBO$FileBOBuilder"));
