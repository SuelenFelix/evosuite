...
public class After_recordDueDate_200794685710 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term167;

    public After_recordDueDate_200794685710() {
    }
    ...
    public void setup() throws Throwable {
        term167 = newInstance(Class.forName("refactoring.app.chapter06.extractMethod.After"));
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        callMethod(klass, "recordDueDate", argTypes, term167, args);
    }
