...
public class CheckovProcessReports_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.hack23.sonar.cloudformation.reports.process.CheckovProcessReports"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CheckovProcessReports_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.hack23.sonar.cloudformation.reports.checkov.EntityTags",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.sonar.api.batch.fs.FileSystem", false, CheckovProcessReports_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sonar.api.batch.sensor.SensorContext", false, CheckovProcessReports_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CheckovProcessReports_ESTest_scaffolding.class.getClassLoader()); 
