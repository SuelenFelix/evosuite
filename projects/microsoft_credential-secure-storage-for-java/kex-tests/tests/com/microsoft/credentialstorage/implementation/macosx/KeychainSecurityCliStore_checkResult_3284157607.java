...
public class KeychainSecurityCliStore_checkResult_3284157607 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term837;

    public KeychainSecurityCliStore_checkResult_3284157607() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[1] = "tbcdzjIfER";
        args[2] = "HyxfbSQYBe";
        callMethod(klass, "checkResult", argTypes, null, args);
    }
