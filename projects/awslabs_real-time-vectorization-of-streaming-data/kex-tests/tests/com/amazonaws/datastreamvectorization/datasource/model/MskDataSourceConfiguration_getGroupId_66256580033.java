...
public class MskDataSourceConfiguration_getGroupId_66256580033 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public MskDataSourceConfiguration_getGroupId_66256580033() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "getGroupId", argTypes, null, args);
    }
