...
public class ExceptionDetails_init_16530050913 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public ExceptionDetails_init_16530050913() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        argTypes[0] = Class.forName("com.skyg0d.spring.jwt.exception.details.ExceptionDetails$ExceptionDetailsBuilder");
