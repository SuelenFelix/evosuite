...
public class MultiTenantApplication_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.codingworld.multitenant.MultiTenantApplication"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(MultiTenantApplication_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.codingworld.multitenant.MultiTenantApplication",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(MultiTenantApplication_ESTest_scaffolding.class.getClassLoader()); 
