...
public class CharDistributionAnalysis_getConfidence_12717365288 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public CharDistributionAnalysis_getConfidence_12717365288() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "getConfidence", argTypes, null, args);
    }
