...
public class LoginCredentials_init_17700768501 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term25;

    public LoginCredentials_init_17700768501() {
    }
    ...
    public void setup() throws Throwable {
        ...
        ((LinkedList) term25).add("MuLcgQHgqz");
        ((LinkedList) term25).add("xxtlPwDYFs");
        ((LinkedList) term25).add("");
