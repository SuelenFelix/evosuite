...
public class GetSlideUseCaseService_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.alkemy.ong.application.service.slide.GetSlideUseCaseService"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(GetSlideUseCaseService_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.alkemy.ong.application.service.slide.usecase.IGetSlideUseCase",
      ...
      "com.alkemy.ong.application.service.slide.GetSlideUseCaseService",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.alkemy.ong.domain.Identifiable", false, GetSlideUseCaseService_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.alkemy.ong.infrastructure.database.repository.abstraction.ISlideSpringRepository", false, GetSlideUseCaseService_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(GetSlideUseCaseService_ESTest_scaffolding.class.getClassLoader()); 
