...
public class FullCommentResponse_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.alkemy.ong.infrastructure.rest.response.comment.FullCommentResponse"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(FullCommentResponse_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.alkemy.ong.infrastructure.rest.response.comment.FullCommentResponse",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(FullCommentResponse_ESTest_scaffolding.class.getClassLoader()); 
