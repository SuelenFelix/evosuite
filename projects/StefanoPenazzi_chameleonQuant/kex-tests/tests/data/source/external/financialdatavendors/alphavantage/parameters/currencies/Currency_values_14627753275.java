...
public class Currency_values_14627753275 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object enum2;

    public Currency_values_14627753275() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term2970 = Class.forName((String) "data.source.external.financialdatavendors.alphavantage.parameters.currencies.Currency");
        Field term2969 = ((Class) term2970).getDeclaredField((String) "SLL");
        ((Field) term2969).setAccessible(true);
        enum2 = ((Field) term2969).get((Object) null);
    }
