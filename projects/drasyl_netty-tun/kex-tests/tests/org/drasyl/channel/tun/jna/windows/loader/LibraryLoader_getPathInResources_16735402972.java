...
public class LibraryLoader_getPathInResources_16735402972 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public LibraryLoader_getPathInResources_16735402972() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "xxtlPwDYFs";
        callMethod(klass, "getPathInResources", argTypes, null, args);
    }
