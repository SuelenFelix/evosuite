...
public class Currency_getValue_3423174629 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object enum5;

    public Currency_getValue_3423174629() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term4301 = Class.forName((String) "data.source.external.financialdatavendors.alphavantage.parameters.currencies.Currency");
        Field term4300 = ((Class) term4301).getDeclaredField((String) "NIO");
        ((Field) term4300).setAccessible(true);
        enum5 = ((Field) term4300).get((Object) null);
    }
