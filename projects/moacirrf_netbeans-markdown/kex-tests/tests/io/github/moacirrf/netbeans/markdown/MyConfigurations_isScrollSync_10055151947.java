...
public class MyConfigurations_isScrollSync_10055151947 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public MyConfigurations_isScrollSync_10055151947() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "isScrollSync", argTypes, null, args);
    }
