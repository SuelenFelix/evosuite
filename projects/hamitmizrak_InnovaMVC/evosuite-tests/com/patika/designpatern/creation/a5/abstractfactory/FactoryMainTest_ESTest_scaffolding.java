...
public class FactoryMainTest_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.patika.designpatern.creation.a5.abstractfactory.FactoryMainTest"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(FactoryMainTest_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.patika.designpatern.creation.a5.abstractfactory.FactoryMainTest",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(FactoryMainTest_ESTest_scaffolding.class.getClassLoader()); 
