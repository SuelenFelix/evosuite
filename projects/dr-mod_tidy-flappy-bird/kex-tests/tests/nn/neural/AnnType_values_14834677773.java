...
public class AnnType_values_14834677773 {
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term814 = Class.forName((String) "nn.neural.AnnType");
        Field term813 = ((Class) term814).getDeclaredField((String) "OUTPUT");
        ((Field) term813).setAccessible(true);
        enum5 = ((Field) term813).get((Object) null);
    }
