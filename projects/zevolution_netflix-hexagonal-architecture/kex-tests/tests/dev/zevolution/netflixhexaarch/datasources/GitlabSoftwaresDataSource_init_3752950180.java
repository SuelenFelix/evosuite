...
public class GitlabSoftwaresDataSource_init_3752950180 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public GitlabSoftwaresDataSource_init_3752950180() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        argTypes[0] = Class.forName("dev.zevolution.netflixhexaarch.datasources.services.GitlabUsersClient");
