...
public class SenseEmbeddingCommand_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.nlpub.watset.cli.SenseEmbeddingCommand"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SenseEmbeddingCommand_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.nlpub.watset.util.Word2VecFormat$1",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SenseEmbeddingCommand_ESTest_scaffolding.class.getClassLoader()); 
