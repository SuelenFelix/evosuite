...
public class AttributesColumn_createColumn_11022912644 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term141;

    public AttributesColumn_createColumn_11022912644() {
    }
    ...
    public void setup() throws Throwable {
        term141 = newInstance(Class.forName("mil.nga.geopackage.attributes.AttributesColumn"));
