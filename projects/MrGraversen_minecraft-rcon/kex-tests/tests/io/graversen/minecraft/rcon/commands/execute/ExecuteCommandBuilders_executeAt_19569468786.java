...
public class ExecuteCommandBuilders_executeAt_19569468786 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term1539;

    public ExecuteCommandBuilders_executeAt_19569468786() {
    }
    ...
    public void setup() throws Throwable {
        term1539 = newInstance(Class.forName("io.graversen.minecraft.rcon.commands.execute.ExecuteCommandBuilders"));
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        callMethod(klass, "executeAt", argTypes, term1539, args);
    }
