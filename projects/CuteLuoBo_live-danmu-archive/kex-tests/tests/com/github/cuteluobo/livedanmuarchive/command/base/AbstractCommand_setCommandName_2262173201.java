...
public class AbstractCommand_setCommandName_2262173201 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public AbstractCommand_setCommandName_2262173201() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "PAEBtnZtTD";
        callMethod(klass, "setCommandName", argTypes, null, args);
    }
