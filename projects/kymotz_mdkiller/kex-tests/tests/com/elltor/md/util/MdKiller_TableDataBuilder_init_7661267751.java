...
public class MdKiller_TableDataBuilder_init_7661267751 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public MdKiller_TableDataBuilder_init_7661267751() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        argTypes[1] = Class.forName("com.elltor.md.util.MdKiller$SectionBuilder");
