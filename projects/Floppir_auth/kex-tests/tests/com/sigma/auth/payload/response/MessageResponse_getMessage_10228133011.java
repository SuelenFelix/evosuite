...
public class MessageResponse_getMessage_10228133011 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term23;

    public MessageResponse_getMessage_10228133011() {
    }
    ...
    public void setup() throws Throwable {
        term23 = newInstance(Class.forName("com.sigma.auth.payload.response.MessageResponse"));
