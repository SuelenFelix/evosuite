...
public class Camera_renderPeron_3452729621 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term1;
     Object term2;

    public Camera_renderPeron_3452729621() {
    }
    ...
    public void setup() throws Throwable {
        term1 = newInstance(Class.forName("refactoring.app.chapter08.movsStatementsToCaller.Camera"));
        term2 = newInstance(Class.forName("refactoring.app.chapter08.movsStatementsToCaller.Person"));
        Object term15 = newInstance(Class.forName("refactoring.app.chapter08.movsStatementsToCaller.Photo"));
