...
public class ProfitServiceImpl_stringToDate_136850560213 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public ProfitServiceImpl_stringToDate_136850560213() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "MvRIxilFMJ";
        callMethod(klass, "stringToDate", argTypes, null, args);
    }
