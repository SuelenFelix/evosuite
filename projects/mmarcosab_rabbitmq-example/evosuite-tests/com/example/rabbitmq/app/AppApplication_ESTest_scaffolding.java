...
public class AppApplication_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.example.rabbitmq.app.AppApplication"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AppApplication_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.example.rabbitmq.app.AppApplication",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AppApplication_ESTest_scaffolding.class.getClassLoader()); 
