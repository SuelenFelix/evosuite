...
public class CognitoAttributesEnum_valueOf_12591086366 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object enum2;

    public CognitoAttributesEnum_valueOf_12591086366() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term1118 = Class.forName((String) "com.authorization.sample.awscognitospringauthserver.domain.enums.CognitoAttributesEnum");
        Field term1117 = ((Class) term1118).getDeclaredField((String) "PASSWORD");
        ((Field) term1117).setAccessible(true);
        enum2 = ((Field) term1117).get((Object) null);
    }
