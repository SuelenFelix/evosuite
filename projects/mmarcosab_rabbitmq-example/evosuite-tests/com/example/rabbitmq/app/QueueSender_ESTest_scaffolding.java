...
public class QueueSender_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.example.rabbitmq.app.QueueSender"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(QueueSender_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.example.rabbitmq.app.QueueSender",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(QueueSender_ESTest_scaffolding.class.getClassLoader()); 
