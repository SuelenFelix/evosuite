...
public class Controller_execute_19033756811 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term47;
     Object term48;

    public Controller_execute_19033756811() {
    }
    ...
    public void setup() throws Throwable {
        term47 = newInstance(Class.forName("codeplays.trainee.cleanarch.infra.adapter.controller.Controller"));
        setField(term47, term47.getClass(), "useCase", null);
        term48 = newInstance(Class.forName("codeplays.trainee.cleanarch.infra.adapter.controller.Request"));
