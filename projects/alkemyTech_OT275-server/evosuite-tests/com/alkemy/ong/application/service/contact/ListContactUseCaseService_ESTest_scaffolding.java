...
public class ListContactUseCaseService_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.alkemy.ong.application.service.contact.ListContactUseCaseService"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ListContactUseCaseService_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.alkemy.ong.application.service.contact.usecase.IListContactUseCase",
      ...
      "com.alkemy.ong.application.service.contact.ListContactUseCaseService",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.alkemy.ong.infrastructure.database.repository.abstraction.IContactSpringRepository", false, ListContactUseCaseService_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ListContactUseCaseService_ESTest_scaffolding.class.getClassLoader()); 
