...
public class FilmDbService_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.sql.Connection", false, FilmDbService_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.DatabaseMetaData", false, FilmDbService_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.Date", false, FilmDbService_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.PreparedStatement", false, FilmDbService_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.ResultSet", false, FilmDbService_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.Statement", false, FilmDbService_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("javax.sql.DataSource", false, FilmDbService_ESTest_scaffolding.class.getClassLoader()));
  }
