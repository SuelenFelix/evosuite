...
public class JwtAuthenticationApplication_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.example.JwtAuthentication.JwtAuthenticationApplication"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(JwtAuthenticationApplication_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.example.JwtAuthentication.JwtAuthenticationApplication",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(JwtAuthenticationApplication_ESTest_scaffolding.class.getClassLoader()); 
