...
public class FileBO_FileBOBuilder_createdAt_21262974918 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term3601;

    public FileBO_FileBOBuilder_createdAt_21262974918() {
    }
    ...
    public void setup() throws Throwable {
        term3601 = newInstance(Class.forName("net.jaggerwang.sbip.entity.FileBO$FileBOBuilder"));
