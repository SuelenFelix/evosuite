...
public class AdminServicesImpl_getAllAdmins_8143578775 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public AdminServicesImpl_getAllAdmins_8143578775() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "getAllAdmins", argTypes, null, args);
    }
