...
public class UserTable_validateContents_153138738330 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public UserTable_validateContents_153138738330() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        callMethod(klass, "validateContents", argTypes, null, args);
    }
