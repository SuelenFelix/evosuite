...
public class CorsProperties_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.leanstacks.ws.security.CorsProperties"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CorsProperties_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.leanstacks.ws.security.CorsProperties",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CorsProperties_ESTest_scaffolding.class.getClassLoader()); 
