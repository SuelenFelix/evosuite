...
public class ItemPocket_getNames_140567882616 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term400;

    public ItemPocket_getNames_140567882616() {
    }
    ...
    public void setup() throws Throwable {
        term400 = newInstance(Class.forName("skaro.pokeapi.resource.itempocket.ItemPocket"));
        setField(term400, term400.getClass(), "id", null);
        setField(term400, term400.getClass(), "name", null);
        setField(term400, term400.getClass(), "categories", null);
