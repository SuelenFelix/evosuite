...
public class After_calculateOutstanding_14597981049 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term166;

    public After_calculateOutstanding_14597981049() {
    }
    ...
    public void setup() throws Throwable {
        term166 = newInstance(Class.forName("refactoring.app.chapter06.extractMethod.After"));
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        callMethod(klass, "calculateOutstanding", argTypes, term166, args);
    }
