...
public class UserService_getEncodedPassword_8162629043 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public UserService_getEncodedPassword_8162629043() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "RMFIsYGgne";
        callMethod(klass, "getEncodedPassword", argTypes, null, args);
    }
