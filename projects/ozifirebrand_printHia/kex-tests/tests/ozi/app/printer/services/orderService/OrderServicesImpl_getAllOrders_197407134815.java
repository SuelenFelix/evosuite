...
public class OrderServicesImpl_getAllOrders_197407134815 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public OrderServicesImpl_getAllOrders_197407134815() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "getAllOrders", argTypes, null, args);
    }
