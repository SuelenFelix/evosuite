...
public class DataBaseGateway_init_8469168060 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public DataBaseGateway_init_8469168060() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        argTypes[0] = Class.forName("codeplays.trainee.cleanarch.infra.adapter.gateway.DataBaseAdapter");
