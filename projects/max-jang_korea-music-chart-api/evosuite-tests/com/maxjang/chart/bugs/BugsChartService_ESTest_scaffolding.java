...
public class BugsChartService_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.maxjang.chart.bugs.BugsChartService"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(BugsChartService_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.maxjang.chart.bugs.BugsChartService",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(BugsChartService_ESTest_scaffolding.class.getClassLoader()); 
