...
public class BeforeAddParameter_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "refactoring.app.chapter06.changeFunctionDeclaration.BeforeAddParameter"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(BeforeAddParameter_ESTest_scaffolding.class.getClassLoader() ,
      "org.springframework.core.env.PropertySource$ComparisonPropertySource",
      "refactoring.app.chapter06.changeFunctionDeclaration.Customer",
      ...
      "refactoring.app.chapter06.changeFunctionDeclaration.BeforeAddParameter",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(BeforeAddParameter_ESTest_scaffolding.class.getClassLoader()); 
