...
public class BaseModel_prepareForUpdate_200674829713 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BaseModel_prepareForUpdate_200674829713() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "prepareForUpdate", argTypes, null, args);
    }
