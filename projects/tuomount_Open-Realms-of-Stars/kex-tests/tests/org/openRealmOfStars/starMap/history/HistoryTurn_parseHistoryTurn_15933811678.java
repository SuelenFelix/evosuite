...
public class HistoryTurn_parseHistoryTurn_15933811678 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public HistoryTurn_parseHistoryTurn_15933811678() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        callMethod(klass, "parseHistoryTurn", argTypes, null, args);
    }
