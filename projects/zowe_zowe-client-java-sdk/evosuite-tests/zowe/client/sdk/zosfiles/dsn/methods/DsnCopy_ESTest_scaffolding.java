...
public class DsnCopy_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "zowe.client.sdk.zosfiles.dsn.methods.DsnCopy"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DsnCopy_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "zowe.client.sdk.zosfiles.dsn.input.DsnCopyInputData",
      ...
      "zowe.client.sdk.zosfiles.dsn.input.DsnCopyInputData$Builder",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("zowe.client.sdk.core.ZosConnection", false, DsnCopy_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("zowe.client.sdk.zosfiles.dsn.input.DsnCopyInputData", false, DsnCopy_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DsnCopy_ESTest_scaffolding.class.getClassLoader()); 
