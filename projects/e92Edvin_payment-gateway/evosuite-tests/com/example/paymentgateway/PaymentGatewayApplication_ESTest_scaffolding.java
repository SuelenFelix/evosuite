...
public class PaymentGatewayApplication_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.example.paymentgateway.PaymentGatewayApplication"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(PaymentGatewayApplication_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.example.paymentgateway.PaymentGatewayApplication",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(PaymentGatewayApplication_ESTest_scaffolding.class.getClassLoader()); 
