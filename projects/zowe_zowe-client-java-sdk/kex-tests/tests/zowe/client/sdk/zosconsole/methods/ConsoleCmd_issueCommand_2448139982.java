...
public class ConsoleCmd_issueCommand_2448139982 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term1;

    public ConsoleCmd_issueCommand_2448139982() {
    }
    ...
    public void setup() throws Throwable {
        term1 = newInstance(Class.forName("zowe.client.sdk.zosconsole.methods.ConsoleCmd"));
