...
public class UsuarioController_listarUsuarios_4889638111 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public UsuarioController_listarUsuarios_4889638111() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "xxtlPwDYFs";
        callMethod(klass, "listarUsuarios", argTypes, null, args);
    }
