...
public class UserIdentityAvailability_getAvailable_5445385680 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term1;

    public UserIdentityAvailability_getAvailable_5445385680() {
    }
    ...
    public void setup() throws Throwable {
        ...
        term1 = newInstance(Class.forName("kyungseo.poc.simple.web.security.dto.response.UserIdentityAvailability"));
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "getAvailable", argTypes, term1, args);
    }
