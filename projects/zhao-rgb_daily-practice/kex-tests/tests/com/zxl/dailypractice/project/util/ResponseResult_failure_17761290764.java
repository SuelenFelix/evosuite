...
public class ResponseResult_failure_17761290764 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object enum0;

    public ResponseResult_failure_17761290764() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term2039 = Class.forName((String) "com.zxl.dailypractice.project.util.ResultCode");
        Field term2038 = ((Class) term2039).getDeclaredField((String) "INTERFACE_FORBID_VISIT");
        ((Field) term2038).setAccessible(true);
        enum0 = ((Field) term2038).get((Object) null);
    }
