...
public class GetUserLoginBonusHandler_init_12905335520 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public GetUserLoginBonusHandler_init_12905335520() {
    }
    ...
    public void test() throws Throwable, Throwable {
        Class<?> klass = Class.forName("icu.samnyan.aqua.sega.chunithm.handler.impl.GetUserLoginBonusHandler");
