...
public class FunctionUtils_downcastIdentity_21089788261 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public FunctionUtils_downcastIdentity_21089788261() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "downcastIdentity", argTypes, null, args);
    }
