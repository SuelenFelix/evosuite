...
public class JediService_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.sql.Connection", false, JediService_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.DatabaseMetaData", false, JediService_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.PreparedStatement", false, JediService_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.ResultSet", false, JediService_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.Statement", false, JediService_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("javax.sql.DataSource", false, JediService_ESTest_scaffolding.class.getClassLoader()));
  }
