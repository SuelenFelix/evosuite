...
public class KafkaWorkersImpl_blockingShutdown_13010373801 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public KafkaWorkersImpl_blockingShutdown_13010373801() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "blockingShutdown", argTypes, null, args);
    }
