...
public class AvoidJcrApiRule_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "ix.ibm.sonar.java.checks.osgi.AvoidJcrApiRule"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AvoidJcrApiRule_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "ix.ibm.sonar.java.utils.JavaFinder",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.sonar.plugins.java.api.semantic.Symbol$MethodSymbol", false, AvoidJcrApiRule_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sonar.plugins.java.api.semantic.Type", false, AvoidJcrApiRule_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sonar.plugins.java.api.tree.IdentifierTree", false, AvoidJcrApiRule_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sonar.plugins.java.api.tree.MethodInvocationTree", false, AvoidJcrApiRule_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AvoidJcrApiRule_ESTest_scaffolding.class.getClassLoader()); 
