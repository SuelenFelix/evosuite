...
public class CoursePrerequisite_when_17099507303 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term97;

    public CoursePrerequisite_when_17099507303() {
    }
    ...
    public void setup() throws Throwable {
        term97 = newInstance(Class.forName("cn.edu.sustech.cs307.dto.prerequisite.CoursePrerequisite"));
        setField(term97, term97.getClass(), "courseID", "xxtlPwDYFs");
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        callMethod(klass, "when", argTypes, term97, args);
    }
