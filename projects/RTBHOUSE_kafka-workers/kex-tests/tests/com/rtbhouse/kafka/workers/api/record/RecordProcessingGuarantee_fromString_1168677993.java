...
public class RecordProcessingGuarantee_fromString_1168677993 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public RecordProcessingGuarantee_fromString_1168677993() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "sjlJAEtRrb";
        callMethod(klass, "fromString", argTypes, null, args);
    }
