...
public class ReportReceiverFreezeSuccessNoticeCreationStrategy_init_10475728330 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public ReportReceiverFreezeSuccessNoticeCreationStrategy_init_10475728330() {
    }
