...
public class SpiderApplication_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.stock.spider.SpiderApplication"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SpiderApplication_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.stock.spider.SpiderApplication",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SpiderApplication_ESTest_scaffolding.class.getClassLoader()); 
