...
public class TryWithResourcesResourceResolverRule_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "ix.ibm.sonar.java.checks.sling.TryWithResourcesResourceResolverRule"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(TryWithResourcesResourceResolverRule_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.sonar.plugins.java.api.tree.LambdaExpressionTree", false, TryWithResourcesResourceResolverRule_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sonar.plugins.java.api.tree.SwitchStatementTree", false, TryWithResourcesResourceResolverRule_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sonar.plugins.java.api.tree.TryStatementTree", false, TryWithResourcesResourceResolverRule_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(TryWithResourcesResourceResolverRule_ESTest_scaffolding.class.getClassLoader()); 
