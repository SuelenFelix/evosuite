...
public class Example1_createBird_10980414753 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term115;

    public Example1_createBird_10980414753() {
    }
    ...
    public void setup() throws Throwable {
        term115 = newInstance(Class.forName("refactoring.app.chapter10.replaceConditionalWithPolymorphism.example1.Example1"));
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "jJCZpVmanW";
        callMethod(klass, "createBird", argTypes, term115, args);
    }
