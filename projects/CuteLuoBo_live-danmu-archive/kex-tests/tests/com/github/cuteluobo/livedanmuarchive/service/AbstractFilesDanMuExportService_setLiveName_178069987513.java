...
public class AbstractFilesDanMuExportService_setLiveName_178069987513 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public AbstractFilesDanMuExportService_setLiveName_178069987513() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "cSHGbqKqlN";
        callMethod(klass, "setLiveName", argTypes, null, args);
    }
