...
public class JwtRefreshTokenService_findByToken_20422693511 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public JwtRefreshTokenService_findByToken_20422693511() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "PAEBtnZtTD";
        callMethod(klass, "findByToken", argTypes, null, args);
    }
