...
public class ApiDivaManageController_getNews_133260428310 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public ApiDivaManageController_getNews_133260428310() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "getNews", argTypes, null, args);
    }
