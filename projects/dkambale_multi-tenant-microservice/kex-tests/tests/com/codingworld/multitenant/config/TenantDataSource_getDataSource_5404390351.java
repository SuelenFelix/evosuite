...
public class TenantDataSource_getDataSource_5404390351 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public TenantDataSource_getDataSource_5404390351() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "MAcUBcBckh";
        callMethod(klass, "getDataSource", argTypes, null, args);
    }
