...
public class ClienteServiceImpl_buscarTodos_13838647301 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public ClienteServiceImpl_buscarTodos_13838647301() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "buscarTodos", argTypes, null, args);
    }
