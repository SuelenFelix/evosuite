...
public class Example_payAmount_5245746654 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term14;

    public Example_payAmount_5245746654() {
    }
    ...
    public void setup() throws Throwable {
        term14 = newInstance(Class.forName("refactoring.app.chapter10.replaceNestedConditionalWithGuardClauses.Example"));
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        callMethod(klass, "payAmount", argTypes, term14, args);
    }
