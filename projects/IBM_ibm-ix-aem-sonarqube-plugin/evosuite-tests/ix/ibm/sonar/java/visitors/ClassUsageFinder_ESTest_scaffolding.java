...
public class ClassUsageFinder_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "ix.ibm.sonar.java.visitors.ClassUsageFinder"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ClassUsageFinder_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "ix.ibm.sonar.java.visitors.ClassUsageFinder",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.sonar.plugins.java.api.semantic.Type", false, ClassUsageFinder_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sonar.plugins.java.api.tree.IdentifierTree", false, ClassUsageFinder_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.sonar.plugins.java.api.tree.Tree", false, ClassUsageFinder_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ClassUsageFinder_ESTest_scaffolding.class.getClassLoader()); 
