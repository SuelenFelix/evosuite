...
public class MaximumSumTwoNonOverlappingSubarrays_maxSumTwoNoOverlap_2768379154 {
    ...
    public void setup() throws Throwable {
        term4888 = newInstance(Class.forName("leetcode.MaximumSumTwoNonOverlappingSubarrays"));
        term4889 = new Integer(0);
        term4891 = new Integer(0);
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[1] = term4889;
        args[2] = term4891;
        callMethod(klass, "maxSumTwoNoOverlap", argTypes, term4888, args);
    }
