...
public class ExperiencedChinaRating_init_8747451390 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term1;
     Object term16;

    public ExperiencedChinaRating_init_8747451390() {
    }
    ...
    public void setup() throws Throwable {
        term1 = newInstance(Class.forName("refactoring.app.chapter10.replaceConditionalWithPolymorphism.example2.Voyage"));
        setField(term1, term1.getClass(), "zone", "PAEBtnZtTD");
        setIntField(term1, term1.getClass(), "length", 568599855);
        setIntField(term1, term1.getClass(), "profit", 1162663216);
        ArrayList term17 = new ArrayList();
        term16 = newInstance(Class.forName("refactoring.app.chapter10.replaceConditionalWithPolymorphism.example2.History"));
        setField(term16, term16.getClass(), "voyages", term17);
    }
