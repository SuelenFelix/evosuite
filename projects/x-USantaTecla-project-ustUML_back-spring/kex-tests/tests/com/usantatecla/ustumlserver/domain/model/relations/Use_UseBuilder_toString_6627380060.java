...
public class Use_UseBuilder_toString_6627380060 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public Use_UseBuilder_toString_6627380060() {
    }
    ...
    public void test() throws Throwable, Throwable {
        Class<?> klass = Class.forName("com.usantatecla.ustumlserver.domain.model.relations.Use$UseBuilder");
