...
public class VibeChartController_init_11718905700 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term1;

    public VibeChartController_init_11718905700() {
    }
    ...
    public void setup() throws Throwable {
        term1 = newInstance(Class.forName("com.maxjang.chart.vibe.VibeChartService"));
    }
