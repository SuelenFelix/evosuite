...
public class CsvExporter_isDangerousValue_1847842408 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public CsvExporter_isDangerousValue_1847842408() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "MjGYSRKTNF";
        callMethod(klass, "isDangerousValue", argTypes, null, args);
    }
