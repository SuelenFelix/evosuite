...
public class Example_calculateSalary_9144737805 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term15;

    public Example_calculateSalary_9144737805() {
    }
    ...
    public void setup() throws Throwable {
        term15 = newInstance(Class.forName("refactoring.app.chapter10.replaceNestedConditionalWithGuardClauses.Example"));
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "calculateSalary", argTypes, term15, args);
    }
