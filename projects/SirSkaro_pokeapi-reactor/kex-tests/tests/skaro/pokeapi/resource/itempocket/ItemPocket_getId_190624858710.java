...
public class ItemPocket_getId_190624858710 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term394;

    public ItemPocket_getId_190624858710() {
    }
    ...
    public void setup() throws Throwable {
        term394 = newInstance(Class.forName("skaro.pokeapi.resource.itempocket.ItemPocket"));
        setField(term394, term394.getClass(), "id", null);
        setField(term394, term394.getClass(), "name", null);
        setField(term394, term394.getClass(), "categories", null);
