...
public class MskDataSourceConfiguration_setGroupId_14891522441 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public MskDataSourceConfiguration_setGroupId_14891522441() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        callMethod(klass, "setGroupId", argTypes, null, args);
    }
