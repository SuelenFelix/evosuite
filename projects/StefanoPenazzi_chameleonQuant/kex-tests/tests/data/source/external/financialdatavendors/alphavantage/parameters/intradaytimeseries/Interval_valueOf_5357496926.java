...
public class Interval_valueOf_5357496926 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object enum3;

    public Interval_valueOf_5357496926() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term1687 = Class.forName((String) "data.source.external.financialdatavendors.alphavantage.parameters.intradaytimeseries.Interval");
        Field term1686 = ((Class) term1687).getDeclaredField((String) "TEN_MIN");
        ((Field) term1686).setAccessible(true);
        enum3 = ((Field) term1686).get((Object) null);
    }
