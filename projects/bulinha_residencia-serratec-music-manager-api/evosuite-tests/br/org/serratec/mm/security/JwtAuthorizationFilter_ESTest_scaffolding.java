...
public class JwtAuthorizationFilter_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("javax.servlet.FilterChain", false, JwtAuthorizationFilter_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("javax.servlet.http.HttpServletRequest", false, JwtAuthorizationFilter_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("javax.servlet.http.HttpServletResponse", false, JwtAuthorizationFilter_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.springframework.security.authentication.AuthenticationManager", false, JwtAuthorizationFilter_ESTest_scaffolding.class.getClassLoader()));
  }
