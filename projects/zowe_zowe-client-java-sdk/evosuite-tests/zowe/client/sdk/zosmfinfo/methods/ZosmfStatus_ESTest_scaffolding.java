...
public class ZosmfStatus_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "zowe.client.sdk.zosmfinfo.methods.ZosmfStatus"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ZosmfStatus_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "zowe.client.sdk.zosmfinfo.response.ZosmfInfoResponse",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("zowe.client.sdk.core.ZosConnection", false, ZosmfStatus_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ZosmfStatus_ESTest_scaffolding.class.getClassLoader()); 
