...
public class AbstractDanMuSender_getRetryCount_190617638414 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public AbstractDanMuSender_getRetryCount_190617638414() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "getRetryCount", argTypes, null, args);
    }
