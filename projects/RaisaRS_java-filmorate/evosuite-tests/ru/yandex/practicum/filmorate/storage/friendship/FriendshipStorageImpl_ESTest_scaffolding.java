...
public class FriendshipStorageImpl_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.sql.Connection", false, FriendshipStorageImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.DatabaseMetaData", false, FriendshipStorageImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.PreparedStatement", false, FriendshipStorageImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.ResultSet", false, FriendshipStorageImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("javax.sql.DataSource", false, FriendshipStorageImpl_ESTest_scaffolding.class.getClassLoader()));
  }
