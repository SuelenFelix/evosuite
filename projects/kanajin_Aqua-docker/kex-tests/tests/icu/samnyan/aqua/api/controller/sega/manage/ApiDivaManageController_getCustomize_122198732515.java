...
public class ApiDivaManageController_getCustomize_122198732515 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public ApiDivaManageController_getCustomize_122198732515() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "getCustomize", argTypes, null, args);
    }
