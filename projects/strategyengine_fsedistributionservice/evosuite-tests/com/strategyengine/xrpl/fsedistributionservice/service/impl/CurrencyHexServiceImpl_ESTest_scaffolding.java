...
public class CurrencyHexServiceImpl_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.strategyengine.xrpl.fsedistributionservice.service.impl.CurrencyHexServiceImpl"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CurrencyHexServiceImpl_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CurrencyHexServiceImpl_ESTest_scaffolding.class.getClassLoader()); 
