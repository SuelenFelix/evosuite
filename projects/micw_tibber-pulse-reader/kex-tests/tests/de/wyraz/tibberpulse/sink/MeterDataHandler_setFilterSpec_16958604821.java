...
public class MeterDataHandler_setFilterSpec_16958604821 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public MeterDataHandler_setFilterSpec_16958604821() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "PAEBtnZtTD";
        callMethod(klass, "setFilterSpec", argTypes, null, args);
    }
