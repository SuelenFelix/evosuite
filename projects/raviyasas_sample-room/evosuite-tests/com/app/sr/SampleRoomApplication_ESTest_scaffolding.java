...
public class SampleRoomApplication_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.app.sr.SampleRoomApplication"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SampleRoomApplication_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.app.sr.SampleRoomApplication",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SampleRoomApplication_ESTest_scaffolding.class.getClassLoader()); 
