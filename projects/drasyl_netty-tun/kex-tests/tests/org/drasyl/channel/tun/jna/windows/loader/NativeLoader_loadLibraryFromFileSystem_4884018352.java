...
public class NativeLoader_loadLibraryFromFileSystem_4884018352 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public NativeLoader_loadLibraryFromFileSystem_4884018352() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "sjlJAEtRrb";
        args[1] = null;
        callMethod(klass, "loadLibraryFromFileSystem", argTypes, null, args);
    }
