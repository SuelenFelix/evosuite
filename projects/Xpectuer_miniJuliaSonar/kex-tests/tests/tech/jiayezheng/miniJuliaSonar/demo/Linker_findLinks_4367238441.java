...
public class Linker_findLinks_4367238441 {
    ...
    public void setup() throws Throwable {
        ...
        Class<? extends Object> term305 = Class.forName((String) "java.io.File$PathStatus");
        Field term304 = ((Class) term305).getDeclaredField((String) "INVALID");
        ((Field) term304).setAccessible(true);
        Object enum1 = ((Field) term304).get((Object) null);
        HashMap term267 = new HashMap();
        Set<Object> term457 =  ((Map) term267).keySet();
        HashSet term266 = new HashSet((Collection<? extends Object>) term457);
        HashMap term282 = new HashMap();
        Set<Object> term458 =  ((Map) term282).keySet();
        HashSet term281 = new HashSet((Collection<? extends Object>) term458);
        ...
        setField(term223, term223.getClass(), "seenRef", term281);
    }
