...
public class UserCustomColumn_copy_179220522818 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term904;

    public UserCustomColumn_copy_179220522818() {
    }
    ...
    public void setup() throws Throwable {
        term904 = newInstance(Class.forName("mil.nga.geopackage.user.custom.UserCustomColumn"));
