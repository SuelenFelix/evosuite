...
public class JsonDanMuExportServiceImpl_getNowUseFile_9657339506 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public JsonDanMuExportServiceImpl_getNowUseFile_9657339506() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "getNowUseFile", argTypes, null, args);
    }
