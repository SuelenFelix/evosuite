...
public class CustomUserDetailsService_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "codeit.gatcha.api.security.service.CustomUserDetailsService"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("codeit.gatcha.domain.user.repo.IUserRepo", false, CustomUserDetailsService_ESTest_scaffolding.class.getClassLoader()));
  }
