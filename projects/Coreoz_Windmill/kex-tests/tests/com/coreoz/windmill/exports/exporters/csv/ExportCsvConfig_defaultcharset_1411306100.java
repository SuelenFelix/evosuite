...
public class ExportCsvConfig_defaultcharset_1411306100 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public ExportCsvConfig_defaultcharset_1411306100() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "$default$charset", argTypes, null, args);
    }
