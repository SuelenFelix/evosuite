...
public class GetGameSettingHandler_init_2257872530 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public GetGameSettingHandler_init_2257872530() {
    }
    ...
    public void test() throws Throwable, Throwable {
        Class<?> klass = Class.forName("icu.samnyan.aqua.sega.chunithm.handler.impl.GetGameSettingHandler");
