...
public class ErrorResponse_getTimestamp_9203372011 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term1;

    public ErrorResponse_getTimestamp_9203372011() {
    }
    ...
    public void setup() throws Throwable {
        term1 = newInstance(Class.forName("com.creativityfactory.swiftserver.error.ErrorResponse"));
        Object term2 = newInstance(Class.forName("java.util.Date"));
        ...
        setField(term1, term1.getClass(), "error", "PAEBtnZtTD");
