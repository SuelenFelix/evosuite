...
public class BerryFirmness_setId_193010696511 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term395;

    public BerryFirmness_setId_193010696511() {
    }
    ...
    public void setup() throws Throwable {
        term395 = newInstance(Class.forName("skaro.pokeapi.resource.berryfirmness.BerryFirmness"));
        setField(term395, term395.getClass(), "id", null);
        setField(term395, term395.getClass(), "name", null);
        setField(term395, term395.getClass(), "berries", null);
