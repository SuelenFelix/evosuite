...
public class ScheduleFreezeTemplate_getTemplate_10190798524 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term3935;

    public ScheduleFreezeTemplate_getTemplate_10190798524() {
    }
    ...
    public void setup() throws Throwable {
        term3935 = newInstance(Class.forName("ru.smartup.timetracker.email.template.impl.ScheduleFreezeTemplate"));
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        callMethod(klass, "getTemplate", argTypes, term3935, args);
    }
