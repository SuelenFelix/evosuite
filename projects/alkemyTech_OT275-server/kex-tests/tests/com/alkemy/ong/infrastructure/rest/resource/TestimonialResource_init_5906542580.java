...
public class TestimonialResource_init_5906542580 {
    ...
    public TestimonialResource_init_5906542580() {
    }
    ...
    public void setup() throws Throwable {
        term7 = newInstance(Class.forName("com.alkemy.ong.infrastructure.rest.mapper.testimonial.CreateTestimonialMapper"));
        term8 = newInstance(Class.forName("com.alkemy.ong.infrastructure.rest.mapper.testimonial.ListTestimonialMapper"));
        Object term9 = newInstance(Class.forName("com.alkemy.ong.infrastructure.rest.mapper.testimonial.GetTestimonialMapper"));
        setField(term8, term8.getClass(), "getTestimonialMapper", term9);
        term10 = newInstance(Class.forName("com.alkemy.ong.infrastructure.common.PaginatedResultsRetrieved"));
        term11 = newInstance(Class.forName("com.alkemy.ong.infrastructure.rest.mapper.testimonial.UpdateTestimonialMapper"));
    }
