...
public class Function_valueOf_12845406766 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object enum3;

    public Function_valueOf_12845406766() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term3075 = Class.forName((String) "data.source.external.financialdatavendors.alphavantage.parameters.functions.Function");
        Field term3074 = ((Class) term3075).getDeclaredField((String) "BBANDS");
        ((Field) term3074).setAccessible(true);
        enum3 = ((Field) term3074).get((Object) null);
    }
