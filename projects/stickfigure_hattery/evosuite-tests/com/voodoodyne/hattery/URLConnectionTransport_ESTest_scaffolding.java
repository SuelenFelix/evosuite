...
public class URLConnectionTransport_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.voodoodyne.hattery.URLConnectionTransport"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(URLConnectionTransport_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.voodoodyne.hattery.URLConnectionTransport$2",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.fasterxml.jackson.databind.deser.DefaultDeserializationContext", false, URLConnectionTransport_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.databind.ser.DefaultSerializerProvider", false, URLConnectionTransport_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.voodoodyne.hattery.ErrorTranslator", false, URLConnectionTransport_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(URLConnectionTransport_ESTest_scaffolding.class.getClassLoader()); 
