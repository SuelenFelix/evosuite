...
public class SpringbootBackendApplication_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.javaguides.SpringbootBackendApplication"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SpringbootBackendApplication_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "net.javaguides.repository.StudentRepository",
      ...
      "net.javaguides.SpringbootBackendApplication",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SpringbootBackendApplication_ESTest_scaffolding.class.getClassLoader()); 
