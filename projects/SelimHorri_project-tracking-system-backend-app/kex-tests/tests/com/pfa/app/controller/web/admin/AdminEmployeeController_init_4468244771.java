...
public class AdminEmployeeController_init_4468244771 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public AdminEmployeeController_init_4468244771() {
    }
    ...
    public void test() throws Throwable, Throwable {
        Class<?> klass = Class.forName("com.pfa.app.controller.web.admin.AdminEmployeeController");
