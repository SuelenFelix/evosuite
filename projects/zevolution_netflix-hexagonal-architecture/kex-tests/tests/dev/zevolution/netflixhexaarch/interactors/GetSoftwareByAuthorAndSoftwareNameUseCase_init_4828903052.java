...
public class GetSoftwareByAuthorAndSoftwareNameUseCase_init_4828903052 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public GetSoftwareByAuthorAndSoftwareNameUseCase_init_4828903052() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        argTypes[0] = Class.forName("dev.zevolution.netflixhexaarch.repositories.SoftwareRepository");
