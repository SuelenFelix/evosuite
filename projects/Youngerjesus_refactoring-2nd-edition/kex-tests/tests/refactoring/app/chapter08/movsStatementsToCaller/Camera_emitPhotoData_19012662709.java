...
public class Camera_emitPhotoData_19012662709 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term299;

    public Camera_emitPhotoData_19012662709() {
    }
    ...
    public void setup() throws Throwable {
        term299 = newInstance(Class.forName("refactoring.app.chapter08.movsStatementsToCaller.Camera"));
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        args[1] = null;
        callMethod(klass, "emitPhotoData", argTypes, term299, args);
    }
