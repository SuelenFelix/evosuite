...
public class MetadataExtension_init_2323909551 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public MetadataExtension_init_2323909551() {
    }
    ...
    public void test() throws Throwable, Throwable {
        Class<?> klass = Class.forName("mil.nga.geopackage.extension.metadata.MetadataExtension");
