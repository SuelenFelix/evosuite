...
public class GeoPackageCoreCache_closeIfNotCached_185277740718 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public GeoPackageCoreCache_closeIfNotCached_185277740718() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        callMethod(klass, "closeIfNotCached", argTypes, null, args);
    }
