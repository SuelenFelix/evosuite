...
public class WithMembersMemberInterpreter_isInvalidModifyKeys_30045806210 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public WithMembersMemberInterpreter_isInvalidModifyKeys_30045806210() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        callMethod(klass, "isInvalidModifyKeys", argTypes, null, args);
    }
