...
public class ListenerBasedCalculator_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "nl.arothuis.antlr4calculator.core.calculator.ListenerBasedCalculator"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ListenerBasedCalculator_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ListenerBasedCalculator_ESTest_scaffolding.class.getClassLoader()); 
