...
public class Interval_values_10277800955 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object enum2;

    public Interval_values_10277800955() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term1189 = Class.forName((String) "data.source.external.financialdatavendors.alphavantage.parameters.intradaytimeseries.Interval");
        Field term1188 = ((Class) term1189).getDeclaredField((String) "FIVE_MIN");
        ((Field) term1188).setAccessible(true);
        enum2 = ((Field) term1188).get((Object) null);
    }
