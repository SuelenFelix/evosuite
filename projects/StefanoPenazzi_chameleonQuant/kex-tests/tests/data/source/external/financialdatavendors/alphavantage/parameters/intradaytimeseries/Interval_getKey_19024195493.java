...
public class Interval_getKey_19024195493 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object enum0;

    public Interval_getKey_19024195493() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term180 = Class.forName((String) "data.source.external.financialdatavendors.alphavantage.parameters.intradaytimeseries.Interval");
        Field term179 = ((Class) term180).getDeclaredField((String) "FIVE_MIN");
        ((Field) term179).setAccessible(true);
        enum0 = ((Field) term179).get((Object) null);
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "getKey", argTypes, enum0, args);
    }
