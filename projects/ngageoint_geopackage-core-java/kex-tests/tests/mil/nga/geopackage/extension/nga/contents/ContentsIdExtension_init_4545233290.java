...
public class ContentsIdExtension_init_4545233290 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public ContentsIdExtension_init_4545233290() {
    }
    ...
    public void test() throws Throwable, Throwable {
        Class<?> klass = Class.forName("mil.nga.geopackage.extension.nga.contents.ContentsIdExtension");
