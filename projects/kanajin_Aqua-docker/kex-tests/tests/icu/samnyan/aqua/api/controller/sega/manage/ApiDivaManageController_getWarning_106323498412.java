...
public class ApiDivaManageController_getWarning_106323498412 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public ApiDivaManageController_getWarning_106323498412() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "getWarning", argTypes, null, args);
    }
