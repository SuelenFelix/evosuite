...
public class PostUsecase_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.jaggerwang.sbip.usecase.PostUsecase"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(PostUsecase_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("javax.inject.Provider", false, PostUsecase_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("javax.persistence.EntityManager", false, PostUsecase_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("javax.persistence.Query", false, PostUsecase_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.jaggerwang.sbip.adapter.dao.jpa.repository.PostLikeRepository", false, PostUsecase_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.jaggerwang.sbip.adapter.dao.jpa.repository.PostRepository", false, PostUsecase_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(PostUsecase_ESTest_scaffolding.class.getClassLoader()); 
