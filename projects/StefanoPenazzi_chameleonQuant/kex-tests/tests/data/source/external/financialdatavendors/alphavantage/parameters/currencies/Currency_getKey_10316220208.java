...
public class Currency_getKey_10316220208 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object enum4;

    public Currency_getKey_10316220208() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term3858 = Class.forName((String) "data.source.external.financialdatavendors.alphavantage.parameters.currencies.Currency");
        Field term3857 = ((Class) term3858).getDeclaredField((String) "GNF");
        ((Field) term3857).setAccessible(true);
        enum4 = ((Field) term3857).get((Object) null);
    }
