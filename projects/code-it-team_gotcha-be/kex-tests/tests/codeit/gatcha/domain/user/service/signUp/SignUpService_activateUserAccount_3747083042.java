...
public class SignUpService_activateUserAccount_3747083042 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public SignUpService_activateUserAccount_3747083042() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "xOcJIiQQDu";
        callMethod(klass, "activateUserAccount", argTypes, null, args);
    }
