...
public class AnnotationType_valueOf_6218673965 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object enum1;

    public AnnotationType_valueOf_6218673965() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term578 = Class.forName((String) "org.openapijsonschematools.codegen.generators.generatormetadata.features.annotations.AnnotationType");
        Field term577 = ((Class) term578).getDeclaredField((String) "ToolingExtension");
        ((Field) term577).setAccessible(true);
        enum1 = ((Field) term577).get((Object) null);
    }
