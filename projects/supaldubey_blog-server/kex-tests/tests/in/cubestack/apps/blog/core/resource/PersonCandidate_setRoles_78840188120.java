...
public class PersonCandidate_setRoles_78840188120 {
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term8847 = Class.forName((String) "in.cubestack.apps.blog.core.domain.PersonStatus");
        Field term8846 = ((Class) term8847).getDeclaredField((String) "DISABLED");
        ((Field) term8846).setAccessible(true);
        Object enum20 = ((Field) term8846).get((Object) null);
        ...
        Set<Object> term9112 =  ((Map) term8757).keySet();
        term8756 = new HashSet((Collection<? extends Object>) term9112);
    }
