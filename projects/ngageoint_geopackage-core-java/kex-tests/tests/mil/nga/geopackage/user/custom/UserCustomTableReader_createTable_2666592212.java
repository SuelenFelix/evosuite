...
public class UserCustomTableReader_createTable_2666592212 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term1204;

    public UserCustomTableReader_createTable_2666592212() {
    }
    ...
    public void setup() throws Throwable {
        term1204 = newInstance(Class.forName("mil.nga.geopackage.user.custom.UserCustomTableReader"));
