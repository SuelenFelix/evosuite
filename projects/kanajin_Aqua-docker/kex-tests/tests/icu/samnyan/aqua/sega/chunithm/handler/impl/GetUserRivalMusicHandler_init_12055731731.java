...
public class GetUserRivalMusicHandler_init_12055731731 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public GetUserRivalMusicHandler_init_12055731731() {
    }
    ...
    public void test() throws Throwable, Throwable {
        Class<?> klass = Class.forName("icu.samnyan.aqua.sega.chunithm.handler.impl.GetUserRivalMusicHandler");
