...
public class AdminServicesImpl_createAdmin_15919836231 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term1;

    public AdminServicesImpl_createAdmin_15919836231() {
    }
    ...
    public void setup() throws Throwable {
        term1 = newInstance(Class.forName("ozi.app.printer.data.dtos.requests.AdminCreationRequest"));
        setField(term1, term1.getClass(), "firstName", "PAEBtnZtTD");
        setField(term1, term1.getClass(), "lastName", "sjlJAEtRrb");
        setField(term1, term1.getClass(), "phoneNumber", "MuLcgQHgqz");
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = term1;
        callMethod(klass, "createAdmin", argTypes, null, args);
    }
