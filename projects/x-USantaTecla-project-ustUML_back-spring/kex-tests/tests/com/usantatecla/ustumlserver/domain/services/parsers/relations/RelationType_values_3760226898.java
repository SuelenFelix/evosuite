...
public class RelationType_values_3760226898 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object enum5;

    public RelationType_values_3760226898() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term2254 = Class.forName((String) "com.usantatecla.ustumlserver.domain.services.parsers.relations.RelationType");
        Field term2253 = ((Class) term2254).getDeclaredField((String) "AGGREGATION");
        ((Field) term2253).setAccessible(true);
        enum5 = ((Field) term2253).get((Object) null);
    }
