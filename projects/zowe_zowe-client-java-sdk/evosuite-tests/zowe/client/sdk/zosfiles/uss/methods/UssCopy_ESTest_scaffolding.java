...
public class UssCopy_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "zowe.client.sdk.zosfiles.uss.methods.UssCopy"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(UssCopy_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "zowe.client.sdk.zosfiles.uss.input.UssCopyInputData$Builder",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("kong.unirest.core.Cookie", false, UssCopy_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("zowe.client.sdk.core.ZosConnection", false, UssCopy_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(UssCopy_ESTest_scaffolding.class.getClassLoader()); 
