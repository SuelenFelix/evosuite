...
public class AdminServicesImpl_deleteAdminById_2732676956 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public AdminServicesImpl_deleteAdminById_2732676956() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "MxlszYVzRf";
        callMethod(klass, "deleteAdminById", argTypes, null, args);
    }
