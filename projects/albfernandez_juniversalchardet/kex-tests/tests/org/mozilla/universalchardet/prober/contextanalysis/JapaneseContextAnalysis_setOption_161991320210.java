...
public class JapaneseContextAnalysis_setOption_161991320210 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public JapaneseContextAnalysis_setOption_161991320210() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "setOption", argTypes, null, args);
    }
