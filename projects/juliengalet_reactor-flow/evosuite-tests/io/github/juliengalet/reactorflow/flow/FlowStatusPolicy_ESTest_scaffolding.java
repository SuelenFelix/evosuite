...
public class FlowStatusPolicy_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "io.github.juliengalet.reactorflow.flow.FlowStatusPolicy"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(FlowStatusPolicy_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("io.github.juliengalet.reactorflow.flow.StepWithMetadata", false, FlowStatusPolicy_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(FlowStatusPolicy_ESTest_scaffolding.class.getClassLoader()); 
