...
public class FileBO_FileBOBuilder_updatedAt_29250166619 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term3602;

    public FileBO_FileBOBuilder_updatedAt_29250166619() {
    }
    ...
    public void setup() throws Throwable {
        term3602 = newInstance(Class.forName("net.jaggerwang.sbip.entity.FileBO$FileBOBuilder"));
