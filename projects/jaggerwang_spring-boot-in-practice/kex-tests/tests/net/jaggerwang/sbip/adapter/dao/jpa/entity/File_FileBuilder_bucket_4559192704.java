...
public class File_FileBuilder_bucket_4559192704 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term1055;

    public File_FileBuilder_bucket_4559192704() {
    }
    ...
    public void setup() throws Throwable {
        ...
        term1055 = newInstance(Class.forName("net.jaggerwang.sbip.adapter.dao.jpa.entity.File$FileBuilder"));
