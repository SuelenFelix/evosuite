...
public class CameraProxyRoutes_createRouteTag_7012048887 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public CameraProxyRoutes_createRouteTag_7012048887() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "xxtlPwDYFs";
        callMethod(klass, "createRouteTag", argTypes, null, args);
    }
