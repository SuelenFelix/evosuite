...
public class ProjectCreateDto_hashCode_70860180912 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term197;

    public ProjectCreateDto_hashCode_70860180912() {
    }
    ...
    public void setup() throws Throwable {
        term197 = newInstance(Class.forName("ru.smartup.timetracker.dto.project.request.ProjectCreateDto"));
