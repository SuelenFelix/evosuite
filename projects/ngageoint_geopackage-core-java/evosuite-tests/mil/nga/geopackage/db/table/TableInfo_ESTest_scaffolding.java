...
public class TableInfo_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "mil.nga.geopackage.db.table.TableInfo"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("mil.nga.geopackage.db.GeoPackageCoreConnection", false, TableInfo_ESTest_scaffolding.class.getClassLoader()));
  }
