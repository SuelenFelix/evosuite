...
public class KafkaWorkersImpl_waitForShutdown_3266237099 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public KafkaWorkersImpl_waitForShutdown_3266237099() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "waitForShutdown", argTypes, null, args);
    }
