...
public class IgnoreLineParser_Token_valueOf_20840987805 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object enum2;

    public IgnoreLineParser_Token_valueOf_20840987805() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term1261 = Class.forName((String) "org.openapijsonschematools.codegen.generatorrunner.ignore.rules.IgnoreLineParser$Token");
        Field term1260 = ((Class) term1261).getDeclaredField((String) "ROOTED_MARKER");
        ((Field) term1260).setAccessible(true);
        enum2 = ((Field) term1260).get((Object) null);
    }
