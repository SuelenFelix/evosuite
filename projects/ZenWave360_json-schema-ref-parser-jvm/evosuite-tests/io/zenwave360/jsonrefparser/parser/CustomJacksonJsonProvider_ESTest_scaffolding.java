...
public class CustomJacksonJsonProvider_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "io.zenwave360.jsonrefparser.parser.CustomJacksonJsonProvider"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CustomJacksonJsonProvider_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.fasterxml.jackson.databind.ser.DefaultSerializerProvider", false, CustomJacksonJsonProvider_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.databind.type.TypeModifier", false, CustomJacksonJsonProvider_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CustomJacksonJsonProvider_ESTest_scaffolding.class.getClassLoader()); 
