...
public class ClientSettingService_getSetting_13207933531 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public ClientSettingService_getSetting_13207933531() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "xxtlPwDYFs";
        callMethod(klass, "getSetting", argTypes, null, args);
    }
