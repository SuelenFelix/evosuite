...
public class File_FileBuilder_region_79277854314 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term3597;

    public File_FileBuilder_region_79277854314() {
    }
    ...
    public void setup() throws Throwable {
        term3597 = newInstance(Class.forName("net.jaggerwang.sbip.adapter.dao.jpa.entity.File$FileBuilder"));
