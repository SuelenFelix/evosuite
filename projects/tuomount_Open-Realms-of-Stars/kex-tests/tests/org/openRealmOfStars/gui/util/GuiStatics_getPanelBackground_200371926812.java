...
public class GuiStatics_getPanelBackground_200371926812 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public GuiStatics_getPanelBackground_200371926812() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        callMethod(klass, "getPanelBackground", argTypes, null, args);
    }
