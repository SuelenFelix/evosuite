...
public class PaymentSchedulerApplication_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.flexpag.paymentscheduler.PaymentSchedulerApplication"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(PaymentSchedulerApplication_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.flexpag.paymentscheduler.PaymentSchedulerApplication",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(PaymentSchedulerApplication_ESTest_scaffolding.class.getClassLoader()); 
