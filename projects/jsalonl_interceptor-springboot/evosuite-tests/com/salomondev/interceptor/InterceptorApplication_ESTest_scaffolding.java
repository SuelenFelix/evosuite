...
public class InterceptorApplication_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.salomondev.interceptor.InterceptorApplication"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(InterceptorApplication_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.salomondev.interceptor.InterceptorApplication",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(InterceptorApplication_ESTest_scaffolding.class.getClassLoader()); 
