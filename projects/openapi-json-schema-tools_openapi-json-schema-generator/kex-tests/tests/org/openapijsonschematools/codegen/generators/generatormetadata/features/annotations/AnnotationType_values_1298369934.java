...
public class AnnotationType_values_1298369934 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object enum0;

    public AnnotationType_values_1298369934() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term62 = Class.forName((String) "org.openapijsonschematools.codegen.generators.generatormetadata.features.annotations.AnnotationType");
        Field term61 = ((Class) term62).getDeclaredField((String) "OAS3");
        ((Field) term61).setAccessible(true);
        enum0 = ((Field) term61).get((Object) null);
    }
