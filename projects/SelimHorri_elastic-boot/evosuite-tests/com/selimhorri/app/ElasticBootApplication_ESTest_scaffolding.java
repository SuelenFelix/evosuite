...
public class ElasticBootApplication_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.selimhorri.app.ElasticBootApplication"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ElasticBootApplication_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.selimhorri.app.ElasticBootApplication",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ElasticBootApplication_ESTest_scaffolding.class.getClassLoader()); 
