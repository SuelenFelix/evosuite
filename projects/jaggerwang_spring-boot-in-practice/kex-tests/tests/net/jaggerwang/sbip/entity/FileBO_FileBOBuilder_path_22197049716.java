...
public class FileBO_FileBOBuilder_path_22197049716 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term3599;

    public FileBO_FileBOBuilder_path_22197049716() {
    }
    ...
    public void setup() throws Throwable {
        term3599 = newInstance(Class.forName("net.jaggerwang.sbip.entity.FileBO$FileBOBuilder"));
